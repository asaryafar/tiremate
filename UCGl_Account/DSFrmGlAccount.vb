...
Public Class DSFrmGlAccount
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmGlAccount = CType(MyBase.Clone,DSFrmGlAccount)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmGlAccount"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmGlAccount.xsd"
    ...
    Public Class GL_accountDataTable
        ...
        Public Overloads Function AddGL_accountRow(ByVal GL_account As String, ByVal desc_GL_account As String, ByVal GL_account_master As String, ByVal group_GL_account As String, ByVal remark As String, ByVal Gl_account_group_subgroup1_code As String, ByVal Gl_account_group_subgroup2_code As String) As GL_accountRow
            Dim rowGL_accountRow As GL_accountRow = CType(Me.NewRow,GL_accountRow)
            rowGL_accountRow.ItemArray = New Object() {GL_account, desc_GL_account, GL_account_master, group_GL_account, remark, Gl_account_group_subgroup1_code, Gl_account_group_subgroup2_code}
    ...
    Public Class GL_accountRow
        ...
        Public Property Gl_account_group_subgroup1_code As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account.Gl_account_group_subgroup1_codeColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account.Gl_account_group_subgroup1_codeColumn) = value
            End Set
        End Property
        ...
        Public Property Gl_account_group_subgroup2_code As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account.Gl_account_group_subgroup2_codeColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account.Gl_account_group_subgroup2_codeColumn) = value
            End Set
        End Property
        ...
        Public Function IsGl_account_group_subgroup1_codeNull() As Boolean
            Return Me.IsNull(Me.tableGL_account.Gl_account_group_subgroup1_codeColumn)
        End Function
        
        Public Sub SetGl_account_group_subgroup1_codeNull()
            Me(Me.tableGL_account.Gl_account_group_subgroup1_codeColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsGl_account_group_subgroup2_codeNull() As Boolean
            Return Me.IsNull(Me.tableGL_account.Gl_account_group_subgroup2_codeColumn)
        End Function
        
        Public Sub SetGl_account_group_subgroup2_codeNull()
            Me(Me.tableGL_account.Gl_account_group_subgroup2_codeColumn) = System.Convert.DBNull
        End Sub
    End Class
