...
Public Class SocialSecurityNoNo
    ...
    Shadows Property Text() As String
        ...
        Set(ByVal Value As String)
            ...
            If _Text <> "" And Val(Mid(_Text, 1, 3)) > 0 Then
                mText = _Text.Split("-")
                If mText(0).Trim.Length = 3 Then
                    TxtNo1.Text = mText(0).Trim
                    TxtNo2.Text = mText(1).Trim
                    TxtNo3.Text = mText(2).Trim
                Else
                    Try
                        Dim Temptext As String = Replace(_Text, "-", "").Trim
                        If TxtNo1.Text.Trim = 9 Then
                            TxtNo1.Text = Mid(Temptext, 1, 3)
                            TxtNo2.Text = Mid(Temptext, 4, 2)
                            TxtNo3.Text = Mid(Temptext, 6, 4)
                        End If
    ...
    Shadows Property BorderStyle() As System.Windows.Forms.BorderStyle
        ...
        End Set
    End Property
    'Shadows Property font() As System.Drawing.Font
    '    Get
    '        Return TxtNo3.Font
    '    End Get
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SocialSecurityNoNo))
...
#End Region
    ...
    Private Sub TxtNo3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtNo3.TextChanged
        RaiseEvent TextChanged(sender, e)
    End Sub
    Private Sub SocialSecurityNo_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize
    ...
    End Sub
    Private Sub SocialSecurityNo_BackColorChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.BackColorChanged
        PnlDate.BackColor = Me.BackColor
        TxtNo3.BackColor = Me.BackColor
        TxtNo2.BackColor = Me.BackColor
        TxtNo1.BackColor = Me.BackColor
    End Sub
    Private Sub SocialSecurityNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.GotFocus
        TxtNo1.Focus()
    End Sub
