...
Public Class DSFrmChargeGroupCostItem
    ...
    Public Class inv_item_cost_transactionRow
        ...
        Public Property cod_quick_refrence As String
            Get
                Try 
                    Return CType(Me(Me.tableinv_item_cost_transaction.cod_quick_refrenceColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableinv_item_cost_transaction.cod_quick_refrenceColumn) = value
            End Set
        End Property
        ...
        Public Function Iscod_quick_refrenceNull() As Boolean
            Return Me.IsNull(Me.tableinv_item_cost_transaction.cod_quick_refrenceColumn)
        End Function
        
        Public Sub Setcod_quick_refrenceNull()
            Me(Me.tableinv_item_cost_transaction.cod_quick_refrenceColumn) = System.Convert.DBNull
        End Sub
