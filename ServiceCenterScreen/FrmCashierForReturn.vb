...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmCashierForReturn1 As ServiceCenterScreen.DSFrmCashierForReturn
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DsFrmCashierForReturn1 = New ServiceCenterScreen.DSFrmCashierForReturn
...
#End Region
    ...
    Private Sub EnableDisableBtn()
        Select Case ThisFormStatus
            Case MainModule.WorkStates.AddNew, MainModule.WorkStates.Edit
                ...
                NumCashAmount.Enabled = True
                NumChargeAmount.Enabled = True
                CmbGL_account.Enabled = True
    ...
    Private Sub BtnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnCancel.Click
        ...
        Me.Close()
    End Sub
    'Private Function CashierSave() As Boolean
    '    Dim ID_paymentVar As Double

    '    CashierSave = True

    '    If NumBalance.Numbervalue <> 0 Then
    ...
    '    If NumCashAmount.Numbervalue > 0 Then 'CASH
    '        If CmbGL_account.Text.Trim.Length = 0 Then
    ...
    '            CmdGeneral.Connection.Open()
    '        End If
    '        CmdGeneral.CommandText = "Select refrence_code FROM GL_Paid_received where tran_type='3' AND id_service_center=" & Qt(TxtRefvar)
    '        If Trim(CmdGeneral.ExecuteScalar & "").Trim.Length > 0 Then
    '            CmdGeneral.CommandText = "UPDATE GL_Paid_received SET amount=" & NumCashAmount.Text & ",GL_account=" & Qt(CmbGL_account.SelectedValue) & " where tran_type='3' AND id_service_center=" & Qt(TxtRefvar)
    '            CmdGeneral.ExecuteNonQuery()
    '        Else
    '            CmdGeneral.CommandText = "INSERT INTO GL_Paid_received (refrence_code, tran_type, action_date, customer_code, amount, GL_account, OtherReceipType, id_service_center) values (" & Qt(MakeNewRef) & ",'3'," & Qt(Datevar) & "," & Qt(CustomerCodvar) & "," & NumCashAmount.Text & "," & Qt(CmbGL_account.SelectedValue) & ",1," & Qt(TxtRefvar) & ")"
    '            CmdGeneral.ExecuteNonQuery()
    '        End If
    '    Else
    '        If CmdGeneral.Connection.State <> ConnectionState.Open Then
    '            CmdGeneral.Connection.Open()
    '        End If
    '        CmdGeneral.CommandText = "DELETE FROM GL_Paid_received where tran_type='3' AND id_service_center=" & Qt(TxtRefvar)
    '        CmdGeneral.ExecuteNonQuery()
    '    End If

    '    If NumChargeAmount.Numbervalue > 0 Then ' CREDIT
    ...
    '        CmdGeneral.CommandText = "Select ID_payment FROM GL_payment_deposit where Refer_type='3' AND payment_type='3' AND id_service_center=" & Qt(TxtRefvar)
    '        Try
    '            ID_paymentVar = CmdGeneral.ExecuteScalar
    '        Catch ex As Exception
    '            ID_paymentVar = 0
    ...
    '            CmdGeneral.CommandText = "UPDATE GL_payment_deposit SET payment_amount=" & NumChargeAmount.Numbervalue & " WHERE ID_payment=" & ID_paymentVar
    '            CmdGeneral.ExecuteNonQuery()
    '            CmdGeneral.CommandText = "UPDATE GL_payment_credit SET cc_type=" & Qt(CmbCCType.SelectedValue) & ",cc_card_no=" & Qt(TXTCardNo.Text) & " WHERE ID_payment=" & ID_paymentVar
    '            CmdGeneral.ExecuteNonQuery()
    '        Else
    '            CmdGeneral.CommandText = "Insert Into GL_payment_deposit (id_service_center,refrence_no,refer_type,payment_type,payment_amount) values (" & Qt(TxtRefvar) & ",NULL,'3','3'," & NumChargeAmount.Numbervalue & ");Select @@Identity from GL_payment_deposit"
    '            ID_paymentVar = CmdGeneral.ExecuteScalar()
    '            CmdGeneral.CommandText = "Insert Into GL_payment_credit (ID_payment,cc_type,cc_card_no,cc_expire_date_year,cc_expire_date_month,cc_auth_no) values (" & ID_paymentVar & "," & Qt(CmbCCType.SelectedValue) & "," & Qt(TXTCardNo.Text) & ",'2099','12','')"
    '            CmdGeneral.ExecuteNonQuery()
    '        End If
    '    Else
    '        If CmdGeneral.Connection.State <> ConnectionState.Open Then
    ...
    '    If DsFrmCashierForReturn1.GL_payment_deposit.Rows.Count > 0 Then 'AR
    '        If CmdGeneral.Connection.State <> ConnectionState.Open Then
    '            CmdGeneral.Connection.Open()
    '        End If
    '        Dim i As Integer
    '        For i = 0 To DsFrmCashierForReturn1.GL_payment_deposit.Rows.Count - 1
    '            If DsFrmCashierForReturn1.GL_payment_deposit.Rows(i).Item("amount_Paid") < DsFrmCashierForReturn1.GL_payment_deposit.Rows(i).Item("payment_amount") Then
    '                CmdGeneral.CommandText = "update GL_payment_AR Set Cancel_Flag=1 where ID_payment=" & DsFrmCashierForReturn1.GL_payment_deposit.Rows(i).Item("ID_payment")
    '                CmdGeneral.ExecuteNonQuery()
    '            Else
    '                CmdGeneral.CommandText = "update GL_payment_AR Set Cancel_Flag=0 where ID_payment=" & DsFrmCashierForReturn1.GL_payment_deposit.Rows(i).Item("ID_payment")
    '                CmdGeneral.ExecuteNonQuery()
    '            End If
    '        Next


    '        CmdGeneral.CommandText = "Select count(*) FROM GL_payment_deposit WHERE id_service_center=" & Qt(TxtRefvar) & " AND refer_type='3' AND payment_type='4' "
    '        If CmdGeneral.ExecuteScalar > 0 Then
    '            CmdGeneral.CommandText = "UPDATE GL_payment_deposit SET payment_amount=" & NumAmountReminder.Numbervalue & " WHERE id_service_center=" & Qt(TxtRefvar) & " AND refer_type='3' AND payment_type='4' "
    '            CmdGeneral.ExecuteNonQuery()
    '        Else
    '            CmdGeneral.CommandText = "Insert Into GL_payment_deposit (id_service_center,refrence_no,refer_type,payment_type,payment_amount) values (" & Qt(TxtRefvar) & ",NULL,'3','4'," & NumAmountReminder.Numbervalue & ");Select @@Identity from GL_payment_deposit"
    '            ID_paymentVar = CmdGeneral.ExecuteScalar()
    '        End If
    '    End If
    'End Function
    Private Function CanCashierSave() As Boolean
        Dim ID_paymentVar As Double
    ...
    '        CmdGeneral.Connection.Open()
    '    End If
    '    CmdGeneral.CommandText = "Select Max(refrence_code) as Max_refrence_code from GL_Paid_received WHERE tran_type='3'"
    '    Try
    '        MakeNewRef = Str(Val(Mid(CmdGeneral.ExecuteScalar, 3, 6)) + 1).Trim
    '    Catch ex As Exception
    '        MakeNewRef = "100001"
    '    End Try
    '    MakeNewRef = "RT" & MakeNewRef
