...
Public Class DSFrmFindServiceRecords
    ...
    Public Class service_center_headDataTable
        ...
        Private columnWOHaveInvoice As DataColumn
        
        Private columnUnit_No As DataColumn
        
        Private columnsum_amount_pay As DataColumn
        ...
        Friend ReadOnly Property WOHaveInvoiceColumn As DataColumn
            Get
                Return Me.columnWOHaveInvoice
            End Get
        End Property
        ...
        Friend ReadOnly Property sum_amount_payColumn As DataColumn
            Get
                Return Me.columnsum_amount_pay
            End Get
        End Property
        ...
        Public Overloads Function Addservice_center_headRow( _
                    ...
                    ByVal WOHaveInvoice As String,  _
                    ByVal Unit_No As String,  _
                    ByVal sum_amount_pay As Decimal,  _
                    ByVal Tax As Decimal) As service_center_headRow
            Dim rowservice_center_headRow As service_center_headRow = CType(Me.NewRow,service_center_headRow)
            rowservice_center_headRow.ItemArray = New Object() {id_service_center, date_refer, l_name, f_name, license_no_vehicle, desc_model, complete_name, phone_1, add_user, vip_code, Total, type_of_form, id_service_center_before, WOHaveInvoice, Unit_No, sum_amount_pay, Tax}
        ...
        Friend Sub InitVars()
            ...
            Me.columnWOHaveInvoice = Me.Columns("WOHaveInvoice")
            Me.columnUnit_No = Me.Columns("Unit_No")
            Me.columnsum_amount_pay = Me.Columns("sum_amount_pay")
        ...
        Private Sub InitClass()
            ...
            Me.columnWOHaveInvoice = New DataColumn("WOHaveInvoice", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnWOHaveInvoice)
            ...
            Me.columnsum_amount_pay = New DataColumn("sum_amount_pay", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnsum_amount_pay)
    ...
    Public Class service_center_headRow
        ...
        Public Property WOHaveInvoice As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_head.WOHaveInvoiceColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_head.WOHaveInvoiceColumn) = value
            End Set
        End Property
        ...
        Public Property sum_amount_pay As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_head.sum_amount_payColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_head.sum_amount_payColumn) = value
            End Set
        End Property
        ...
        Public Property Tax As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_head.TaxColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Function IsWOHaveInvoiceNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_head.WOHaveInvoiceColumn)
        End Function
        
        Public Sub SetWOHaveInvoiceNull()
            Me(Me.tableservice_center_head.WOHaveInvoiceColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function Issum_amount_payNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_head.sum_amount_payColumn)
        End Function
        
        Public Sub Setsum_amount_payNull()
            Me(Me.tableservice_center_head.sum_amount_payColumn) = System.Convert.DBNull
        End Sub
