...
#End Region
    ...
    Private Sub TxtComments_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TxtComments.TextChanged
        If TxtComments.Enabled Then
            CmdOk.Enabled = True
        End If
    End Sub
    'Private Sub FrmComments_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.LostFocus
    '    RaiseEvent CloseMe()
    'End Sub
    'Private Sub FrmComments_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
