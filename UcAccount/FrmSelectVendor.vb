...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmSelectVendor))
        ...
        Me.Panel4.Size = New System.Drawing.Size(410, 48)
        ...
        "Position>2</Position><SelectableCells>FilterRowCells</SelectableCells><Width>241" & _
        "</Width></Column2></Columns><GroupCondition ID="""" /><SortKeys Collection=""true"">" & _
        ...
        Me.GrdMain.Size = New System.Drawing.Size(416, 472)
...
#End Region
    ...
    Private Sub FrmSelectVendor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub FillVendor()
        GrdMain.RootTable.Columns(1).Caption = "Vendor"
        GrdMain.RootTable.Columns(2).Caption = "Vendor Name"
        GrdMain.RootTable.SortKeys.RemoveAt(0)

        Dim grdSort As New GridEXSortKey
        Dim col As New GridEXColumn
        col = GrdMain.RootTable.Columns(2)
        grdSort.Column = col
        grdSort.SortOrder = SortOrder.Ascending
        GrdMain.RootTable.SortKeys.Add(grdSort)
    ...
    Private Sub Fillbuy()
        Try
            GrdMain.DataSource = DSMAIN.Tables("buy")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
