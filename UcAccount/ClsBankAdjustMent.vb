Imports CommonClass
Public Class ClsBankAdjustMent
#Region "ClsDefine"
...
#End Region
    ...
    Public Function MakeNewRefCod() As String
        ...
        Try
            ...
            End If
            CmdGeneral.CommandText = "Select Max(Id_Adjustment_no) as Max_cod from bank_adjustment_head"
    ...
    Public Function LastRecord() As String
        If CmdGeneral.Connection.State <> ConnectionState.Open Then
            CmdGeneral.Connection.Open()
        End If
        CmdGeneral.CommandText = "Select top 1 Id_Adjustment_no as Max from bank_adjustment_head  ORDER BY Id_Adjustment_no DESC"
        Try
    ...
    Function PFirstRecord() As String
        ...
        If CmdGeneral.Connection.State <> ConnectionState.Open Then
            CmdGeneral.Connection.Open()
        End If
        CmdGeneral.CommandText = "SELECT Top 1 Id_Adjustment_no From bank_adjustment_head Order BY Id_Adjustment_no ASC"
    ...
    Function PLastRecord() As String
        ...
        If CmdGeneral.Connection.State <> ConnectionState.Open Then
            CmdGeneral.Connection.Open()
        End If
        CmdGeneral.CommandText = "SELECT Top 1 Id_Adjustment_no From bank_adjustment_head Order  BY Id_Adjustment_no Des"
    ...
    Function Pprevious(ByVal FromThis As String) As String
        If CmdGeneral.Connection.State <> ConnectionState.Open Then
            CmdGeneral.Connection.Open()
        End If
        CmdGeneral.CommandText = "SELECT Top 1 Id_Adjustment_no From bank_adjustment_head  WHERE  Id_Adjustment_no< " & Qt(FromThis) & " Order BY Id_Adjustment_no Desc"
    ...
    Function PNext(ByVal FromThis As String) As String
        If CmdGeneral.Connection.State <> ConnectionState.Open Then
            CmdGeneral.Connection.Open()
        End If
        CmdGeneral.CommandText = "SELECT Top 1 Id_Adjustment_no From bank_adjustment_head WHERE  Id_Adjustment_no > " & Qt(FromThis) & " Order BY Id_Adjustment_no "
