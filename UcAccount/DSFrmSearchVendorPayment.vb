...
Public Class DSFrmSearchVendorPayment
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmSearchVendorPayment = CType(MyBase.Clone,DSFrmSearchVendorPayment)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmSearchVendorPayment"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmSearchVendorPayment.xsd"
    ...
    Public Class GL_AP_paymentDataTable
        ...
        Public Overloads Function AddGL_AP_paymentRow(ByVal date_prepare As String, ByVal cod_vendor As String, ByVal desc_vendor As String, ByVal address As String) As GL_AP_paymentRow
            Dim rowGL_AP_paymentRow As GL_AP_paymentRow = CType(Me.NewRow,GL_AP_paymentRow)
            rowGL_AP_paymentRow.ItemArray = New Object() {date_prepare, cod_vendor, desc_vendor, address}
