...
Public Class DSFrmDeleteFinance
    Inherits DataSet
    
    Private tableGL_account_adjustment_head As GL_account_adjustment_headDataTable
    
    Private tableFinanceDate As FinanceDateDataTable
    ...
    Protected Sub New(ByVal info As SerializationInfo, ByVal context As StreamingContext)
        ...
        If (Not (strSchema) Is Nothing) Then
            ...
            End If
            If (Not (ds.Tables("FinanceDate")) Is Nothing) Then
                Me.Tables.Add(New FinanceDateDataTable(ds.Tables("FinanceDate")))
            End If
    ...
    <System.ComponentModel.Browsable(false),  _
     System.ComponentModel.DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Content)>  _
    Public ReadOnly Property FinanceDate As FinanceDateDataTable
        Get
            Return Me.tableFinanceDate
        End Get
    End Property
    
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmDeleteFinance = CType(MyBase.Clone,DSFrmDeleteFinance)
        cln.InitVars
        Return cln
    End Function
    ...
    Friend Sub InitVars()
        ...
        End If
        Me.tableFinanceDate = CType(Me.Tables("FinanceDate"),FinanceDateDataTable)
        If (Not (Me.tableFinanceDate) Is Nothing) Then
            Me.tableFinanceDate.InitVars
        End If
    End Sub
    
    Private Sub InitClass()
        Me.DataSetName = "DSFrmDeleteFinance"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmDeleteFinance.xsd"
        ...
        Me.tableFinanceDate = New FinanceDateDataTable
        Me.Tables.Add(Me.tableFinanceDate)
    End Sub
    ...
    Private Function ShouldSerializeFinanceDate() As Boolean
        Return false
    End Function
    ...
    Public Delegate Sub FinanceDateRowChangeEventHandler(ByVal sender As Object, ByVal e As FinanceDateRowChangeEvent)
    ...
    Public Class GL_account_adjustment_headDataTable
        ...
        Public Overloads Function AddGL_account_adjustment_headRow(ByVal refrence_no As String, ByVal cod_customer As String, ByVal date_adjustment As String, ByVal Remark As String, ByVal GL_account As String, ByVal id_GL_journal As Integer, ByVal Gl_receive_payment_Refrence_no As String, ByVal finance_charge_flag As Boolean, ByVal complete_name As String, ByVal m_name As String, ByVal amount_adjustment As Decimal) As GL_account_adjustment_headRow
            Dim rowGL_account_adjustment_headRow As GL_account_adjustment_headRow = CType(Me.NewRow,GL_account_adjustment_headRow)
            rowGL_account_adjustment_headRow.ItemArray = New Object() {refrence_no, cod_customer, date_adjustment, Remark, GL_account, id_GL_journal, Gl_receive_payment_Refrence_no, finance_charge_flag, complete_name, m_name, amount_adjustment}
        ...
        Private Sub InitClass()
            ...
            Me.columnGl_receive_payment_Refrence_no.ReadOnly = true
            Me.columncomplete_name.ReadOnly = true
            Me.columnm_name.ReadOnly = true
        End Sub
    ...
    Public Class GL_account_adjustment_headRow
        ...
        Public Property complete_name As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account_adjustment_head.complete_nameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account_adjustment_head.complete_nameColumn) = value
            End Set
        End Property
        ...
        Public Property m_name As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account_adjustment_head.m_nameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account_adjustment_head.m_nameColumn) = value
            End Set
        End Property
        ...
        Public Function Iscomplete_nameNull() As Boolean
            Return Me.IsNull(Me.tableGL_account_adjustment_head.complete_nameColumn)
        End Function
        
        Public Sub Setcomplete_nameNull()
            Me(Me.tableGL_account_adjustment_head.complete_nameColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Ism_nameNull() As Boolean
            Return Me.IsNull(Me.tableGL_account_adjustment_head.m_nameColumn)
        End Function
        
        Public Sub Setm_nameNull()
            Me(Me.tableGL_account_adjustment_head.m_nameColumn) = System.Convert.DBNull
        End Sub
    ...
    <System.Diagnostics.DebuggerStepThrough()>  _
    Public Class FinanceDateDataTable
        Inherits DataTable
        Implements System.Collections.IEnumerable
        ...
        Public Default ReadOnly Property Item(ByVal index As Integer) As FinanceDateRow
            Get
                Return CType(Me.Rows(index),FinanceDateRow)
            End Get
        End Property
        
        Public Event FinanceDateRowChanged As FinanceDateRowChangeEventHandler
        
        Public Event FinanceDateRowChanging As FinanceDateRowChangeEventHandler
        
        Public Event FinanceDateRowDeleted As FinanceDateRowChangeEventHandler
        
        Public Event FinanceDateRowDeleting As FinanceDateRowChangeEventHandler
        
        Public Overloads Sub AddFinanceDateRow(ByVal row As FinanceDateRow)
            Me.Rows.Add(row)
        End Sub
        
        Public Overloads Function AddFinanceDateRow(ByVal date_adjustment As String) As FinanceDateRow
            Dim rowFinanceDateRow As FinanceDateRow = CType(Me.NewRow,FinanceDateRow)
            rowFinanceDateRow.ItemArray = New Object() {date_adjustment}
            Me.Rows.Add(rowFinanceDateRow)
            Return rowFinanceDateRow
        End Function
        ...
        Public Overrides Function Clone() As DataTable
            Dim cln As FinanceDateDataTable = CType(MyBase.Clone,FinanceDateDataTable)
            cln.InitVars
            Return cln
        End Function
        
        Protected Overrides Function CreateInstance() As DataTable
            Return New FinanceDateDataTable
        End Function
        ...
        Public Function NewFinanceDateRow() As FinanceDateRow
            Return CType(Me.NewRow,FinanceDateRow)
        End Function
        
        Protected Overrides Function NewRowFromBuilder(ByVal builder As DataRowBuilder) As DataRow
            Return New FinanceDateRow(builder)
        End Function
        
        Protected Overrides Function GetRowType() As System.Type
            Return GetType(FinanceDateRow)
        End Function
        
        Protected Overrides Sub OnRowChanged(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowChanged(e)
            If (Not (Me.FinanceDateRowChangedEvent) Is Nothing) Then
                RaiseEvent FinanceDateRowChanged(Me, New FinanceDateRowChangeEvent(CType(e.Row,FinanceDateRow), e.Action))
            End If
        End Sub
        
        Protected Overrides Sub OnRowChanging(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowChanging(e)
            If (Not (Me.FinanceDateRowChangingEvent) Is Nothing) Then
                RaiseEvent FinanceDateRowChanging(Me, New FinanceDateRowChangeEvent(CType(e.Row,FinanceDateRow), e.Action))
            End If
        End Sub
        
        Protected Overrides Sub OnRowDeleted(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowDeleted(e)
            If (Not (Me.FinanceDateRowDeletedEvent) Is Nothing) Then
                RaiseEvent FinanceDateRowDeleted(Me, New FinanceDateRowChangeEvent(CType(e.Row,FinanceDateRow), e.Action))
            End If
        End Sub
        
        Protected Overrides Sub OnRowDeleting(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowDeleting(e)
            If (Not (Me.FinanceDateRowDeletingEvent) Is Nothing) Then
                RaiseEvent FinanceDateRowDeleting(Me, New FinanceDateRowChangeEvent(CType(e.Row,FinanceDateRow), e.Action))
            End If
        End Sub
        
        Public Sub RemoveFinanceDateRow(ByVal row As FinanceDateRow)
            Me.Rows.Remove(row)
        End Sub
    End Class
    
    <System.Diagnostics.DebuggerStepThrough()>  _
    Public Class FinanceDateRow
        Inherits DataRow
        ...
        Friend Sub New(ByVal rb As DataRowBuilder)
            MyBase.New(rb)
            Me.tableFinanceDate = CType(Me.Table,FinanceDateDataTable)
        End Sub
        
        Public Property date_adjustment As String
            Get
                Try 
                    Return CType(Me(Me.tableFinanceDate.date_adjustmentColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableFinanceDate.date_adjustmentColumn) = value
            End Set
        End Property
        
        Public Function Isdate_adjustmentNull() As Boolean
            Return Me.IsNull(Me.tableFinanceDate.date_adjustmentColumn)
        End Function
        
        Public Sub Setdate_adjustmentNull()
            Me(Me.tableFinanceDate.date_adjustmentColumn) = System.Convert.DBNull
        End Sub
    End Class
    
    <System.Diagnostics.DebuggerStepThrough()>  _
    Public Class FinanceDateRowChangeEvent
        Inherits EventArgs
        
        Private eventRow As FinanceDateRow
        
        Private eventAction As DataRowAction
        
        Public Sub New(ByVal row As FinanceDateRow, ByVal action As DataRowAction)
            MyBase.New
            Me.eventRow = row
            Me.eventAction = action
        End Sub
        
        Public ReadOnly Property Row As FinanceDateRow
            Get
                Return Me.eventRow
            End Get
        End Property
