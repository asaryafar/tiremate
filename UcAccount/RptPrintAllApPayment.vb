...
Public Class RptPrintAllApPayment
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RptPrintAllApPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPrintAllApPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPrintAllApPayment = New RptPrintAllApPayment
        rpt.Site = Me.Site
        Return rpt
    End Function
