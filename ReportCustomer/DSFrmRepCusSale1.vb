...
Public Class DSFrmRepCusSale
    ...
    Public Class sourceDataTable
        ...
        Public Overloads Function AddsourceRow(ByVal cod As String, ByVal description As String, ByVal flag As Boolean) As sourceRow
            Dim rowsourceRow As sourceRow = CType(Me.NewRow,sourceRow)
            rowsourceRow.ItemArray = New Object() {cod, description, flag}
    ...
    Public Class territoryDataTable
        ...
        Public Overloads Function AddterritoryRow(ByVal cod As String, ByVal description As String, ByVal flag As Boolean) As territoryRow
            Dim rowterritoryRow As territoryRow = CType(Me.NewRow,territoryRow)
            rowterritoryRow.ItemArray = New Object() {cod, description, flag}
    ...
    Public Class territoryRow
        ...
        Public Property flag As Boolean
            Get
                Try 
                    Return CType(Me(Me.tableterritory.flagColumn),Boolean)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableterritory.flagColumn) = value
            End Set
        End Property
        ...
        Public Function IsflagNull() As Boolean
            Return Me.IsNull(Me.tableterritory.flagColumn)
        End Function
        
        Public Sub SetflagNull()
            Me(Me.tableterritory.flagColumn) = System.Convert.DBNull
        End Sub
    End Class
    ...
    Public Class employeeDataTable
        ...
        Public Overloads Function AddemployeeRow(ByVal cod As String, ByVal f_name As String, ByVal l_name As String, ByVal complete_name As String, ByVal flag As Boolean) As employeeRow
            Dim rowemployeeRow As employeeRow = CType(Me.NewRow,employeeRow)
            rowemployeeRow.ItemArray = New Object() {cod, f_name, l_name, complete_name, flag}
    ...
    Public Class employeeRow
        ...
        Public Sub Setcomplete_nameNull()
            Me(Me.tableemployee.complete_nameColumn) = System.Convert.DBNull
        End Sub
