...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmSelectJournal))
...
#End Region
    ...
    Private Sub FrmSelectJournal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Select Case TypeOfForm
            Case KindForm.Acount
                Call FillAcount()
            Case KindForm.Journal
                Call FillJournal()
            Case KindForm.Group
                Call FillGroup()
            Case KindForm.sub1
    ...
    Private Sub FillAcount()
        Try
            GrdMain.DataSource = DSMAIN.Tables("acount")
        ...
        End Try
    End Sub
    Private Sub FillJournal()
        Try
            GrdMain.DataSource = DSMAIN.Tables("Journal")
            GrdMain.BringToFront()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub FillGroup()
        Try
            GrdMain.DataSource = DSMAIN.Tables("Group")
            GrdMain.BringToFront()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    Private Sub FillSub1()
        Try
            GrdMain.DataSource = DSMAIN.Tables("Sub1")
            GrdMain.BringToFront()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    Private Sub FillSub2()
        Try
            GrdMain.DataSource = DSMAIN.Tables("Sub2")
            GrdMain.BringToFront()
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
