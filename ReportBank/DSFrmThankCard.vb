...
Public Class DSFrmThankCard
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmThankCard = CType(MyBase.Clone,DSFrmThankCard)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmThankCard"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmThankCard.xsd"
