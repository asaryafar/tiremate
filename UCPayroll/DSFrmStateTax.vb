...
Public Class DSFrmStateTax
    ...
    Private tablepay_tab_state_tax_head As pay_tab_state_tax_headDataTable
    ...
    Protected Sub New(ByVal info As SerializationInfo, ByVal context As StreamingContext)
        ...
        If (Not (strSchema) Is Nothing) Then
            ...
            End If
            If (Not (ds.Tables("pay_tab_state_tax_head")) Is Nothing) Then
                Me.Tables.Add(New pay_tab_state_tax_headDataTable(ds.Tables("pay_tab_state_tax_head")))
            End If
    ...
    <System.ComponentModel.Browsable(false),  _
     System.ComponentModel.DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Content)>  _
    Public ReadOnly Property pay_tab_state_tax_head As pay_tab_state_tax_headDataTable
        Get
            Return Me.tablepay_tab_state_tax_head
        End Get
    End Property
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmStateTax = CType(MyBase.Clone,DSFrmStateTax)
        cln.InitVars
        Return cln
    End Function
    ...
    Friend Sub InitVars()
        ...
        End If
        Me.tablepay_tab_state_tax_head = CType(Me.Tables("pay_tab_state_tax_head"),pay_tab_state_tax_headDataTable)
        If (Not (Me.tablepay_tab_state_tax_head) Is Nothing) Then
            Me.tablepay_tab_state_tax_head.InitVars
        End If
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmStateTax"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmStateTax.xsd"
        ...
        Me.tablepay_tab_state_tax_head = New pay_tab_state_tax_headDataTable
        Me.Tables.Add(Me.tablepay_tab_state_tax_head)
    ...
    Private Function ShouldSerializepay_tab_state_tax_head() As Boolean
        Return false
    End Function
    ...
    Public Delegate Sub pay_tab_state_tax_headRowChangeEventHandler(ByVal sender As Object, ByVal e As pay_tab_state_tax_headRowChangeEvent)
    ...
    <System.Diagnostics.DebuggerStepThrough()>  _
    Public Class pay_tab_state_tax_headDataTable
        Inherits DataTable
        Implements System.Collections.IEnumerable
        ...
        Friend Sub New()
            MyBase.New("pay_tab_state_tax_head")
            Me.InitClass
        End Sub
        ...
        Public Default ReadOnly Property Item(ByVal index As Integer) As pay_tab_state_tax_headRow
            Get
                Return CType(Me.Rows(index),pay_tab_state_tax_headRow)
            End Get
        End Property
        
        Public Event pay_tab_state_tax_headRowChanged As pay_tab_state_tax_headRowChangeEventHandler
        
        Public Event pay_tab_state_tax_headRowChanging As pay_tab_state_tax_headRowChangeEventHandler
        
        Public Event pay_tab_state_tax_headRowDeleted As pay_tab_state_tax_headRowChangeEventHandler
        
        Public Event pay_tab_state_tax_headRowDeleting As pay_tab_state_tax_headRowChangeEventHandler
        
        Public Overloads Sub Addpay_tab_state_tax_headRow(ByVal row As pay_tab_state_tax_headRow)
            Me.Rows.Add(row)
        End Sub
        
        Public Overloads Function Addpay_tab_state_tax_headRow(ByVal year_Status As String) As pay_tab_state_tax_headRow
            Dim rowpay_tab_state_tax_headRow As pay_tab_state_tax_headRow = CType(Me.NewRow,pay_tab_state_tax_headRow)
            rowpay_tab_state_tax_headRow.ItemArray = New Object() {year_Status, Nothing}
            Me.Rows.Add(rowpay_tab_state_tax_headRow)
            Return rowpay_tab_state_tax_headRow
        End Function
        ...
        Public Overrides Function Clone() As DataTable
            Dim cln As pay_tab_state_tax_headDataTable = CType(MyBase.Clone,pay_tab_state_tax_headDataTable)
            cln.InitVars
            Return cln
        End Function
        
        Protected Overrides Function CreateInstance() As DataTable
            Return New pay_tab_state_tax_headDataTable
        End Function
        ...
        Private Sub InitClass()
            ...
            Me.columnId_State_Tax.AutoIncrement = true
            Me.columnId_State_Tax.AllowDBNull = false
            Me.columnId_State_Tax.ReadOnly = true
        End Sub
        
        Public Function Newpay_tab_state_tax_headRow() As pay_tab_state_tax_headRow
            Return CType(Me.NewRow,pay_tab_state_tax_headRow)
        End Function
        
        Protected Overrides Function NewRowFromBuilder(ByVal builder As DataRowBuilder) As DataRow
            Return New pay_tab_state_tax_headRow(builder)
        End Function
        
        Protected Overrides Function GetRowType() As System.Type
            Return GetType(pay_tab_state_tax_headRow)
        End Function
        
        Protected Overrides Sub OnRowChanged(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowChanged(e)
            If (Not (Me.pay_tab_state_tax_headRowChangedEvent) Is Nothing) Then
                RaiseEvent pay_tab_state_tax_headRowChanged(Me, New pay_tab_state_tax_headRowChangeEvent(CType(e.Row,pay_tab_state_tax_headRow), e.Action))
            End If
        End Sub
        
        Protected Overrides Sub OnRowChanging(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowChanging(e)
            If (Not (Me.pay_tab_state_tax_headRowChangingEvent) Is Nothing) Then
                RaiseEvent pay_tab_state_tax_headRowChanging(Me, New pay_tab_state_tax_headRowChangeEvent(CType(e.Row,pay_tab_state_tax_headRow), e.Action))
            End If
        End Sub
        
        Protected Overrides Sub OnRowDeleted(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowDeleted(e)
            If (Not (Me.pay_tab_state_tax_headRowDeletedEvent) Is Nothing) Then
                RaiseEvent pay_tab_state_tax_headRowDeleted(Me, New pay_tab_state_tax_headRowChangeEvent(CType(e.Row,pay_tab_state_tax_headRow), e.Action))
            End If
        End Sub
        
        Protected Overrides Sub OnRowDeleting(ByVal e As DataRowChangeEventArgs)
            MyBase.OnRowDeleting(e)
            If (Not (Me.pay_tab_state_tax_headRowDeletingEvent) Is Nothing) Then
                RaiseEvent pay_tab_state_tax_headRowDeleting(Me, New pay_tab_state_tax_headRowChangeEvent(CType(e.Row,pay_tab_state_tax_headRow), e.Action))
            End If
        End Sub
        
        Public Sub Removepay_tab_state_tax_headRow(ByVal row As pay_tab_state_tax_headRow)
            Me.Rows.Remove(row)
        End Sub
    End Class
    
    <System.Diagnostics.DebuggerStepThrough()>  _
    Public Class pay_tab_state_tax_headRow
        Inherits DataRow
        ...
        Friend Sub New(ByVal rb As DataRowBuilder)
            MyBase.New(rb)
            Me.tablepay_tab_state_tax_head = CType(Me.Table,pay_tab_state_tax_headDataTable)
        End Sub
        
        Public Property year_Status As String
            Get
                Try 
                    Return CType(Me(Me.tablepay_tab_state_tax_head.year_StatusColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablepay_tab_state_tax_head.year_StatusColumn) = value
            End Set
        End Property
        
        Public Property Id_State_Tax As Integer
            Get
                Return CType(Me(Me.tablepay_tab_state_tax_head.Id_State_TaxColumn),Integer)
            End Get
            Set
                Me(Me.tablepay_tab_state_tax_head.Id_State_TaxColumn) = value
            End Set
        End Property
        
        Public Function Isyear_StatusNull() As Boolean
            Return Me.IsNull(Me.tablepay_tab_state_tax_head.year_StatusColumn)
        End Function
        
        Public Sub Setyear_StatusNull()
            Me(Me.tablepay_tab_state_tax_head.year_StatusColumn) = System.Convert.DBNull
        End Sub
    End Class
    
    <System.Diagnostics.DebuggerStepThrough()>  _
    Public Class pay_tab_state_tax_headRowChangeEvent
        Inherits EventArgs
        
        Private eventRow As pay_tab_state_tax_headRow
        
        Private eventAction As DataRowAction
        
        Public Sub New(ByVal row As pay_tab_state_tax_headRow, ByVal action As DataRowAction)
            MyBase.New
            Me.eventRow = row
            Me.eventAction = action
        End Sub
        
        Public ReadOnly Property Row As pay_tab_state_tax_headRow
            Get
                Return Me.eventRow
            End Get
        End Property
    ...
    Public Class pay_tab_state_tax_dtlDataTable
        ...
        Public Overloads Function Addpay_tab_state_tax_dtlRow(ByVal over_ As Decimal, ByVal but_not_over As Decimal, ByVal percent_tax As Decimal, ByVal radif As Short, ByVal dollor_tax As Decimal) As pay_tab_state_tax_dtlRow
            Dim rowpay_tab_state_tax_dtlRow As pay_tab_state_tax_dtlRow = CType(Me.NewRow,pay_tab_state_tax_dtlRow)
            rowpay_tab_state_tax_dtlRow.ItemArray = New Object() {over_, but_not_over, percent_tax, radif, dollor_tax}
