...
Public Class DSFrmWorkOrders
    ...
    Public Class service_out_purchasesDataTable
        ...
        Public Overloads Function Addservice_out_purchasesRow( _
            ...
            rowservice_out_purchasesRow.ItemArray = New Object() {id_service_center, radif, part_no, description, cost, fet, price, markup, cod_vendor, po_no, line, invoice_no, invoice_date, due_date, tracking_warranty, in_day, in_mile, tracking_core, core_value, AR_terms}
        ...
        Private Sub InitClass()
            ...
            Me.columncore_value = New DataColumn("core_value", GetType(System.Single), Nothing, System.Data.MappingType.Element)
    ...
    Public Class service_out_purchasesRow
        ...
        Public Property core_value As Single
            Get
                Try 
                    Return CType(Me(Me.tableservice_out_purchases.core_valueColumn),Single)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
