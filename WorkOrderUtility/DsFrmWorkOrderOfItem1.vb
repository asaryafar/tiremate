...
Public Class DsFrmWorkOrderOfItem
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DsFrmWorkOrderOfItem = CType(MyBase.Clone,DsFrmWorkOrderOfItem)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DsFrmWorkOrderOfItem"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DsFrmWorkOrderOfItem.xsd"
    ...
    Public Class service_center_headDataTable
        ...
        Public Overloads Function Addservice_center_headRow(ByVal id_service_center As String, ByVal type_of_form As String, ByVal cod_customer As String, ByVal date_refer As String, ByVal cod_select As String, ByVal qty As Single, ByVal customer As String) As service_center_headRow
            Dim rowservice_center_headRow As service_center_headRow = CType(Me.NewRow,service_center_headRow)
            rowservice_center_headRow.ItemArray = New Object() {id_service_center, type_of_form, cod_customer, date_refer, cod_select, qty, customer}
    ...
    Public Class service_center_headRow
        ...
        Public Property qty As Single
            Get
                Return CType(Me(Me.tableservice_center_head.qtyColumn),Single)
            End Get
            Set
        ...
        Public Property customer As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_head.customerColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_head.customerColumn) = value
            End Set
        End Property
        ...
        Public Function IscustomerNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_head.customerColumn)
        End Function
        
        Public Sub SetcustomerNull()
            Me(Me.tableservice_center_head.customerColumn) = System.Convert.DBNull
        End Sub
    End Class
