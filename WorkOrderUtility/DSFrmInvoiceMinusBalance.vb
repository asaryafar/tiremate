...
Public Class DSFrmInvoiceMinusBalance
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmInvoiceMinusBalance = CType(MyBase.Clone,DSFrmInvoiceMinusBalance)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmInvoiceMinusBalance"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmInvoiceMinusBalance.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal cod_customer As String, ByVal date_refer As String, ByVal fullname As String, ByVal abbreviation_name As String, ByVal Total As Decimal) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, cod_customer, date_refer, fullname, abbreviation_name, Total}
