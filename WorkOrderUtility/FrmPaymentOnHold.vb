...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmPaymentOnHold1 As DSFrmPaymentOnHold
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim GridEXLayout1 As Janus.Windows.GridEX.GridEXLayout = New Janus.Windows.GridEX.GridEXLayout
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmPaymentOnHold))
        Me.GridEX1 = New Janus.Windows.GridEX.GridEX
        Me.DsFrmPaymentOnHold1 = New WorkOrderUtility.DSFrmPaymentOnHold
        ...
        CType(Me.DsFrmPaymentOnHold1, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.GridEX1.DataSource = Me.DsFrmPaymentOnHold1
        ...
        'DsFrmPaymentOnHold1
        '
        Me.DsFrmPaymentOnHold1.DataSetName = "DSFrmPaymentOnHold"
        Me.DsFrmPaymentOnHold1.Locale = New System.Globalization.CultureInfo("fa-IR")
        '
        'Cnn
        '
        ...
        "ervice_center_head.date_refer, service_center_head.Total, cust_trtab_main.f_name" & _
        " + ' ' + cust_trtab_main.m_name + ' ' + cust_trtab_main.l_name AS fullname, cust" & _
        "_company.abbreviation_name FROM service_center_head LEFT OUTER JOIN cust_trtab_m" & _
        "ain ON service_center_head.cod_customer = cust_trtab_main.cod_customer LEFT OUTE" & _
        ...
        Me.Name = "FrmPaymentOnHold"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Payment On Hold"
        CType(Me.GridEX1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.DsFrmPaymentOnHold1, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    Private Sub FrmCashInvoices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DAservice_center_dtl.SelectCommand.CommandText = DAservice_center_dtl.SelectCommand.CommandText & WhereClauseVar & " AND (id_service_center NOT IN (SELECT id_service_center FROM gl_payment_deposit)) ORDER BY service_center_head.id_service_center"
        DAservice_center_dtl.Fill(DsFrmPaymentOnHold1.service_center_dtl)
    End Sub
