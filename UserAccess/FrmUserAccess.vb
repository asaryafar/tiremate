...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmUserAccess1 As UserAccess.DSFrmUserAccess
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DsFrmUserAccess1 = New UserAccess.DSFrmUserAccess
        ...
        CType(Me.DsFrmUserAccess1, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'TreeView1
        '
        ...
        'BtnCollapseAll
        '
        Me.BtnCollapseAll.Location = New System.Drawing.Point(273, 13)
        Me.BtnCollapseAll.Name = "BtnCollapseAll"
        Me.BtnCollapseAll.Size = New System.Drawing.Size(93, 21)
        Me.BtnCollapseAll.TabIndex = 36
        Me.BtnCollapseAll.Text = "Collapse All"
        '
        'BtnExpandAll
        '
        Me.BtnExpandAll.Location = New System.Drawing.Point(396, 13)
        Me.BtnExpandAll.Name = "BtnExpandAll"
        Me.BtnExpandAll.Size = New System.Drawing.Size(93, 21)
        ...
        'CmdGeneralForMDB
        '
        Me.CmdGeneralForMDB.CommandText = "SELECT FormName, Item_large_icon, Item_small_icon, Itemdesc, ItemKey, ItemKind, I" & _
        ...
        Me.CmbUser.DataSource = Me.DsFrmUserAccess1.Users
        ...
        'DsFrmUserAccess1
        '
        Me.DsFrmUserAccess1.DataSetName = "DSFrmUserAccess"
        Me.DsFrmUserAccess1.Locale = New System.Globalization.CultureInfo("fa-IR")
        '
        'Label1
        '
        ...
        CType(Me.DsFrmUserAccess1, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    Private Sub FrmGroupMenu_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End Try
        Dim Dr As DataRow
        DsFrmUserAccess1.Clear()
        DaUsers.Fill(DsFrmUserAccess1, "users")
        DaMainMenu.Fill(DsFrmUserAccess1, "Items")
    ...
    Private Sub MakeTree(ByVal ThisTree As TreeNode, ByVal ThisDataTable As DataTable, ByVal ThisIdParent As Integer)
        ...
        If DV.Count >= 0 Then
            For i = 0 To DV.Count - 1
                ...
                If IsAccessByThisUser(CmbUser.SelectedValue, DV.Item(i).Item("ItemKey")) Then
                    MyTreeNode.Checked = True
                Else
                    MyTreeNode.Checked = False
                End If
                Call MakeTree(MyTreeNode, DsFrmUserAccess1.Items, DV.Item(i).Item("ItemKey"))
            Next
        End If
    End Sub
    ...
    Private Sub AddNode(ByVal ThisUserId As Integer, ByVal ThisMenuId As Integer)
        ...
        End If
        CmdGeneralForMDB.CommandText = "insert into UserAccess (UserId,ItemKey) values(" & ThisUserId & "," & ThisMenuId & ")"
        Try
    ...
    Private Sub DelNode(ByVal ThisUserId As Integer, ByVal ThisMenuId As Integer)
        If CmdGeneralForMDB.Connection.State <> ConnectionState.Open Then
            CmdGeneralForMDB.Connection.Open()
        End If
        CmdGeneralForMDB.CommandText = "Delete From UserAccess Where UserId=" & ThisUserId & " AND ItemKey=" & ThisMenuId
        Try
            CmdGeneralForMDB.ExecuteNonQuery()
            CmdGeneralForMDB.CommandText = "Delete From UserFavorite Where UserId=" & ThisUserId & " AND ItemKey=" & ThisMenuId
            CmdGeneralForMDB.ExecuteNonQuery()
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub StartMakeNode()
        ...
        If CmdGeneralForMDB.Connection.State <> ConnectionState.Open Then
            CmdGeneralForMDB.Connection.Open()
        End If
        CmdGeneralForMDB.CommandText = "Select UserName+' '+UserFamily as UserFullName From Users Where UserId=" & CmbUser.SelectedValue
        CmdGeneralForMDB.CommandText = "Select UserFamily as UserFullName From Users Where UserId=" & CmbUser.SelectedValue
        Try
            LblUserName.Text = CmdGeneralForMDB.ExecuteScalar
        Catch ex As Exception
            LblUserName.Text = ""
        End Try
        ...
        Call MakeTree(TreeView1.TopNode, DsFrmUserAccess1.Items, 0)
    ...
    Function IsAccessByThisUser(ByVal ThisUserId As Integer, ByVal ThisMenuId As Integer) As Boolean
        ...
        DAUserAccess.SelectCommand.CommandText = "SELECT COUNT(*) AS aa FROM UserAccess Where UserId=" & ThisUserId & " AND ItemKey=" & ThisMenuId
