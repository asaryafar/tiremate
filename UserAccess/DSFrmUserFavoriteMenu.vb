...
Public Class DSFrmUserFavoriteMenu
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmUserFavoriteMenu = CType(MyBase.Clone,DSFrmUserFavoriteMenu)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmUserFavoriteMenu"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmUserFavoriteMenu.xsd"
    ...
    Public Class UserAccessRow
        ...
        Public Function IsItemKeyNull() As Boolean
            Return Me.IsNull(Me.tableUserAccess.ItemKeyColumn)
        End Function
        
        Public Sub SetItemKeyNull()
            Me(Me.tableUserAccess.ItemKeyColumn) = System.Convert.DBNull
        End Sub
