...
Public Class Reference_No
    ...
    Dim WithEvents ClsVendorReferenceNo1 As New ClsVendorReferenceNo
...
#End Region
    ...
    Private Sub TxtReferencNo_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, TxtReferencNo.KeyUp
        ...
        End Select
    End Sub
    Private Sub MyFrmSearchReferenceNo_ReceivePaymentFind(ByVal ThisReferencNo As String, ByVal ThisCod_Vendor As String) Handles MyFrmSearchReferenceNo.ReceivePaymentFind
