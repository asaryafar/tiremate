...
Public Class DSFrmVendorHistory
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmVendorHistory = CType(MyBase.Clone,DSFrmVendorHistory)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmVendorHistory"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmVendorHistory.xsd"
