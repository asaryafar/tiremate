...
Public Class ClsVendorReferenceNo
    '------------------------------------------
    ...
    Function FindDesc(ByVal ThisRefrence_No As String) As Boolean
        ...
        CmdSelect.CommandText = "SELECT  * " _
                              & " FROM GL_AP_Bill_Head " _
                              & " Where GL_AP_Bill_Head.Id_AP_bill_Head = " & Qt(ThisRefrence_No)
        Try
            DaGeneral.Fill(DsGeneral, "t1")
            If DsGeneral.Tables("t1").Rows.Count > 0 Then
                MRefrence_No = DsGeneral.Tables("t1").Rows(0).Item("Id_AP_bill_Head")
