...
Public Class DSFrmEndOfDayOutsidePurchasesReport
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayOutsidePurchasesReport = CType(MyBase.Clone,DSFrmEndOfDayOutsidePurchasesReport)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayOutsidePurchasesReport"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayOutsidePurchasesReport.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal qty As Decimal, ByVal Ext_Price As Decimal, ByVal cod_select As String, ByVal cod_vendor As String, ByVal invoice_no As String, ByVal ExtCost As Single, ByVal desc_item As String, ByVal flag As Boolean, ByVal due_date As String) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, qty, Ext_Price, cod_select, cod_vendor, invoice_no, ExtCost, desc_item, flag, due_date}
    ...
    Public Class service_center_dtlRow
        ...
        Public Property due_date As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.due_dateColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.due_dateColumn) = value
            End Set
        End Property
        ...
        Public Function Isdue_dateNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.due_dateColumn)
        End Function
        
        Public Sub Setdue_dateNull()
            Me(Me.tableservice_center_dtl.due_dateColumn) = System.Convert.DBNull
        End Sub
    End Class
