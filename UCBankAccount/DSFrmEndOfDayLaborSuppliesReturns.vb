...
Public Class DSFrmEndOfDayLaborSuppliesReturns
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayLaborSuppliesReturns = CType(MyBase.Clone,DSFrmEndOfDayLaborSuppliesReturns)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayLaborSuppliesReturns"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayLaborSuppliesReturns.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal qty As Decimal, ByVal Ext_Price As Decimal, ByVal cod_select As String, ByVal desc_service As String, ByVal service_type_desc As String) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, qty, Ext_Price, cod_select, desc_service, service_type_desc}
    ...
    Public Class service_center_dtlRow
        ...
        Public Property service_type_desc As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.service_type_descColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.service_type_descColumn) = value
            End Set
        End Property
        ...
        Public Function Isservice_type_descNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.service_type_descColumn)
        End Function
        
        Public Sub Setservice_type_descNull()
            Me(Me.tableservice_center_dtl.service_type_descColumn) = System.Convert.DBNull
        End Sub
    End Class
