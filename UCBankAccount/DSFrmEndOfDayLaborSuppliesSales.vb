...
Public Class DSFrmEndOfDayLaborSuppliesSales
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayLaborSuppliesSales = CType(MyBase.Clone,DSFrmEndOfDayLaborSuppliesSales)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayLaborSuppliesSales"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayLaborSuppliesSales.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal qty As Decimal, ByVal Ext_Price As Decimal, ByVal Type As String, ByVal cod_select As String, ByVal desc_service As String, ByVal cost As Single, ByVal GrProfAmount As Decimal, ByVal GrProfPercent As Decimal) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, qty, Ext_Price, Type, cod_select, desc_service, cost, GrProfAmount, GrProfPercent}
    ...
    Public Class service_center_dtlRow
        ...
        Public Property desc_service As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.desc_serviceColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.desc_serviceColumn) = value
            End Set
        End Property
        ...
        Public Property cost As Single
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.costColumn),Single)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Function Isdesc_serviceNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.desc_serviceColumn)
        End Function
        
        Public Sub Setdesc_serviceNull()
            Me(Me.tableservice_center_dtl.desc_serviceColumn) = System.Convert.DBNull
        End Sub
