...
Public Class DSFrmEndOfDayProductsReport
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayProductsReport = CType(MyBase.Clone,DSFrmEndOfDayProductsReport)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayProductsReport"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayProductsReport.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal date_refer As String, ByVal cod_select As String, ByVal desc_item As String, ByVal qty As Decimal, ByVal price As Decimal, ByVal fet As Decimal, ByVal ExtPrice As Decimal, ByVal desc_item_type As String, ByVal StoreNo As Object, ByVal flag As Boolean, ByVal cod_vendor As String, ByVal desc_vendor As String, ByVal Type As String, ByVal ExtCost As Decimal) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, date_refer, cod_select, desc_item, qty, price, fet, ExtPrice, desc_item_type, StoreNo, flag, cod_vendor, desc_vendor, Type, ExtCost}
        ...
        Private Sub InitClass()
            ...
            Me.columnStoreNo = New DataColumn("StoreNo", GetType(System.Object), Nothing, System.Data.MappingType.Element)
            ...
            Me.columnStoreNo.ReadOnly = true
    ...
    Public Class service_center_dtlRow
        ...
        Public Property ExtPrice As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.ExtPriceColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.ExtPriceColumn) = value
            End Set
        End Property
        ...
        Public Property desc_item_type As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.desc_item_typeColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.desc_item_typeColumn) = value
            End Set
        End Property
        
        Public Property StoreNo As Object
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.StoreNoColumn),Object)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Property desc_vendor As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.desc_vendorColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.desc_vendorColumn) = value
            End Set
        End Property
        ...
        Public Function IsExtPriceNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.ExtPriceColumn)
        End Function
        
        Public Sub SetExtPriceNull()
            Me(Me.tableservice_center_dtl.ExtPriceColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Isdesc_item_typeNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.desc_item_typeColumn)
        End Function
        
        Public Sub Setdesc_item_typeNull()
            Me(Me.tableservice_center_dtl.desc_item_typeColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function Isdesc_vendorNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.desc_vendorColumn)
        End Function
        
        Public Sub Setdesc_vendorNull()
            Me(Me.tableservice_center_dtl.desc_vendorColumn) = System.Convert.DBNull
        End Sub
