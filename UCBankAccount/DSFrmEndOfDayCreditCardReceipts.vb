...
Public Class DSFrmEndOfDayCreditCardReceipts
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayCreditCardReceipts = CType(MyBase.Clone,DSFrmEndOfDayCreditCardReceipts)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayCreditCardReceipts"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayCreditCardReceipts.xsd"
    ...
    Public Class Gl_receive_paymentDataTable
        ...
        Public Overloads Function AddGl_receive_paymentRow(ByVal refrence_no As String, ByVal date_receive_payment As String, ByVal fullname As String, ByVal abbreviation_name As String, ByVal amount_receive As Single, ByVal cc_type_desc As String) As Gl_receive_paymentRow
            Dim rowGl_receive_paymentRow As Gl_receive_paymentRow = CType(Me.NewRow,Gl_receive_paymentRow)
            rowGl_receive_paymentRow.ItemArray = New Object() {refrence_no, date_receive_payment, fullname, abbreviation_name, amount_receive, cc_type_desc}
    ...
    Public Class Gl_receive_paymentRow
        ...
        Public Property cc_type_desc As String
            Get
                Try 
                    Return CType(Me(Me.tableGl_receive_payment.cc_type_descColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGl_receive_payment.cc_type_descColumn) = value
            End Set
        End Property
        ...
        Public Function Iscc_type_descNull() As Boolean
            Return Me.IsNull(Me.tableGl_receive_payment.cc_type_descColumn)
        End Function
        
        Public Sub Setcc_type_descNull()
            Me(Me.tableGl_receive_payment.cc_type_descColumn) = System.Convert.DBNull
        End Sub
    End Class
