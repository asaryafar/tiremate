...
Public Class DSFrmEndOfDayCashReport
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayCashReport = CType(MyBase.Clone,DSFrmEndOfDayCashReport)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayCashReport"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayCashReport.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Private columnCash_Amount As DataColumn
        
        Private columnCheckAmount As DataColumn
        
        Private columncheck_no As DataColumn
        
        Private columnCredit_Amount As DataColumn
        ...
        Friend ReadOnly Property Cash_AmountColumn As DataColumn
            Get
                Return Me.columnCash_Amount
            End Get
        End Property
        
        Friend ReadOnly Property CheckAmountColumn As DataColumn
            Get
        ...
        Friend ReadOnly Property Credit_AmountColumn As DataColumn
            Get
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal Total As Decimal, ByVal fullname As String, ByVal abbreviation_name As String, ByVal cod_customer As String, ByVal date_refer As String, ByVal Cash_Amount As Decimal, ByVal CheckAmount As Decimal, ByVal check_no As String, ByVal Credit_Amount As Decimal, ByVal cc_type_desc As String, ByVal flag As Boolean) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, Total, fullname, abbreviation_name, cod_customer, date_refer, Cash_Amount, CheckAmount, check_no, Credit_Amount, cc_type_desc, flag}
        ...
        Friend Sub InitVars()
            ...
            Me.columnCash_Amount = Me.Columns("Cash_Amount")
            Me.columnCheckAmount = Me.Columns("CheckAmount")
            Me.columncheck_no = Me.Columns("check_no")
            Me.columnCredit_Amount = Me.Columns("Credit_Amount")
        ...
        Private Sub InitClass()
            ...
            Me.columnCash_Amount = New DataColumn("Cash_Amount", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnCash_Amount)
            Me.columnCheckAmount = New DataColumn("CheckAmount", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnCheckAmount)
            ...
            Me.columnCredit_Amount = New DataColumn("Credit_Amount", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnCredit_Amount)
    ...
    Public Class service_center_dtlRow
        ...
        Public Property Cash_Amount As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.Cash_AmountColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.Cash_AmountColumn) = value
            End Set
        End Property
        ...
        Public Property CheckAmount As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.CheckAmountColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.CheckAmountColumn) = value
            End Set
        End Property
        ...
        Public Property check_no As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.check_noColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.check_noColumn) = value
            End Set
        End Property
        ...
        Public Property Credit_Amount As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.Credit_AmountColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.Credit_AmountColumn) = value
            End Set
        End Property
        ...
        Public Property cc_type_desc As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.cc_type_descColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.cc_type_descColumn) = value
            End Set
        End Property
        ...
        Public Function IsCash_AmountNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.Cash_AmountColumn)
        End Function
        
        Public Sub SetCash_AmountNull()
            Me(Me.tableservice_center_dtl.Cash_AmountColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsCheckAmountNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.CheckAmountColumn)
        End Function
        
        Public Sub SetCheckAmountNull()
            Me(Me.tableservice_center_dtl.CheckAmountColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Ischeck_noNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.check_noColumn)
        End Function
        
        Public Sub Setcheck_noNull()
            Me(Me.tableservice_center_dtl.check_noColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsCredit_AmountNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.Credit_AmountColumn)
        End Function
        
        Public Sub SetCredit_AmountNull()
            Me(Me.tableservice_center_dtl.Credit_AmountColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Iscc_type_descNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.cc_type_descColumn)
        End Function
        
        Public Sub Setcc_type_descNull()
            Me(Me.tableservice_center_dtl.cc_type_descColumn) = System.Convert.DBNull
        End Sub
