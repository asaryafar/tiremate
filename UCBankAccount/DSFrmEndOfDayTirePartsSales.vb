...
Public Class DSFrmEndOfDayTirePartsSales
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayTirePartsSales = CType(MyBase.Clone,DSFrmEndOfDayTirePartsSales)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayTirePartsSales"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayTirePartsSales.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Private columnCustomerCompleteName As DataColumn
        ...
        Friend ReadOnly Property CustomerCompleteNameColumn As DataColumn
            Get
                Return Me.columnCustomerCompleteName
            End Get
        End Property
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal desc_item As String, ByVal qty As Decimal, ByVal Ext_Price As Decimal, ByVal Type As String, ByVal cod_select As String, ByVal ExtCost As Single, ByVal GrProfitAmount As Single, ByVal GrProfitPercent As Long, ByVal CustomerCompleteName As String, ByVal CompanyName As String) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, desc_item, qty, Ext_Price, Type, cod_select, ExtCost, GrProfitAmount, GrProfitPercent, CustomerCompleteName, CompanyName}
        ...
        Friend Sub InitVars()
            ...
            Me.columnCustomerCompleteName = Me.Columns("CustomerCompleteName")
        ...
        Private Sub InitClass()
            ...
            Me.columnGrProfitAmount = New DataColumn("GrProfitAmount", GetType(System.Single), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnGrProfitAmount)
            Me.columnGrProfitPercent = New DataColumn("GrProfitPercent", GetType(System.Int64), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnGrProfitPercent)
            Me.columnCustomerCompleteName = New DataColumn("CustomerCompleteName", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnCustomerCompleteName)
    ...
    Public Class service_center_dtlRow
        ...
        Public Property GrProfitAmount As Single
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.GrProfitAmountColumn),Single)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Property GrProfitPercent As Long
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.GrProfitPercentColumn),Long)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Property CustomerCompleteName As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.CustomerCompleteNameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.CustomerCompleteNameColumn) = value
            End Set
        End Property
        ...
        Public Function IsCustomerCompleteNameNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.CustomerCompleteNameColumn)
        End Function
        
        Public Sub SetCustomerCompleteNameNull()
            Me(Me.tableservice_center_dtl.CustomerCompleteNameColumn) = System.Convert.DBNull
        End Sub
