...
Public Class DSFrmEndOfDayFeesReturns
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayFeesReturns = CType(MyBase.Clone,DSFrmEndOfDayFeesReturns)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayFeesReturns"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayFeesReturns.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal desc_item As String, ByVal qty As Decimal, ByVal Ext_Price As Decimal, ByVal Type As String, ByVal cod_select As String) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, desc_item, qty, Ext_Price, Type, cod_select}
