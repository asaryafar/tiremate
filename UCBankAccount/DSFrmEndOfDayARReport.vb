...
Public Class DSFrmEndOfDayARReport
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayARReport = CType(MyBase.Clone,DSFrmEndOfDayARReport)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayARReport"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayARReport.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal Total As Decimal, ByVal Charge As Decimal, ByVal Credit As Decimal, ByVal fullname As String, ByVal abbreviation_name As String, ByVal date_refer As String, ByVal flag As Integer, ByVal memo As String, ByVal cod_customer As String) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, Total, Charge, Credit, fullname, abbreviation_name, date_refer, flag, memo, cod_customer}
    ...
    Public Class service_center_dtlRow
        ...
        Public Property Charge As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.ChargeColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.ChargeColumn) = value
            End Set
        End Property
        ...
        Public Property Credit As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.CreditColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.CreditColumn) = value
            End Set
        End Property
        ...
        Public Property flag As Integer
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.flagColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Property memo As String
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.memoColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.memoColumn) = value
            End Set
        End Property
        ...
        Public Function IsChargeNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.ChargeColumn)
        End Function
        
        Public Sub SetChargeNull()
            Me(Me.tableservice_center_dtl.ChargeColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsCreditNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.CreditColumn)
        End Function
        
        Public Sub SetCreditNull()
            Me(Me.tableservice_center_dtl.CreditColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IsmemoNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.memoColumn)
        End Function
        
        Public Sub SetmemoNull()
            Me(Me.tableservice_center_dtl.memoColumn) = System.Convert.DBNull
        End Sub
