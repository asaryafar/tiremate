...
Public Class DSFrmEndOfDayATMWithdrawals
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayATMWithdrawals = CType(MyBase.Clone,DSFrmEndOfDayATMWithdrawals)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayATMWithdrawals"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayATMWithdrawals.xsd"
