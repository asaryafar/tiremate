...
Public Class DSFrmEndOfDayOutsidePurchasesReturns
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayOutsidePurchasesReturns = CType(MyBase.Clone,DSFrmEndOfDayOutsidePurchasesReturns)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayOutsidePurchasesReturns"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayOutsidePurchasesReturns.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal qty As Decimal, ByVal Ext_Price As Decimal, ByVal cod_select As String, ByVal cod_vendor As String, ByVal invoice_no As String, ByVal desc_item As String) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, qty, Ext_Price, cod_select, cod_vendor, invoice_no, desc_item}
