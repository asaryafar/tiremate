...
Imports CommonClass
Public Class FrmEndOfDayCreditCardReceipts
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmEndOfDayCreditCardReceipts1 As UCBankAccount.DSFrmEndOfDayCreditCardReceipts
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEndOfDayCreditCardReceipts))
        Me.GridEX1 = New Janus.Windows.GridEX.GridEX
        Me.DsFrmEndOfDayCreditCardReceipts1 = New UCBankAccount.DSFrmEndOfDayCreditCardReceipts
        ...
        CType(Me.DsFrmEndOfDayCreditCardReceipts1, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.GridEX1.DataSource = Me.DsFrmEndOfDayCreditCardReceipts1
        ...
        "n>C.C. Received</Caption><DataMember>amount_receive</DataMember><Key>amount_rece" & _
        "ive</Key><Position>2</Position><Width>96</Width></Column2><Column3 ID=""cc_type_d" & _
        "esc""><Caption>C.C. Type</Caption><DataMember>cc_type_desc</DataMember><Key>cc_ty" & _
        "pe_desc</Key><Position>3</Position><Width>94</Width></Column3><Column4 ID=""fulln" & _
        "ame""><Caption>Customer Name</Caption><DataMember>fullname</DataMember><EditType>" & _
        "NoEdit</EditType><Key>fullname</Key><Position>4</Position><Width>172</Width></Co" & _
        "lumn4><Column5 ID=""abbreviation_name""><Caption>Company</Caption><DataMember>abbr" & _
        "eviation_name</DataMember><Key>abbreviation_name</Key><Position>5</Position><Wid" & _
        "th>107</Width></Column5></Columns><GroupCondition ID="""" /><Key>Gl_receive_paymen" & _
        "t</Key></RootTable></GridEXLayoutData>"
        ...
        '
        'DsFrmEndOfDayCreditCardReceipts1
        '
        Me.DsFrmEndOfDayCreditCardReceipts1.DataSetName = "DSFrmEndOfDayCreditCardReceipts"
        Me.DsFrmEndOfDayCreditCardReceipts1.Locale = New System.Globalization.CultureInfo("fa-IR")
        '
        'Cnn
        '
        Me.Cnn.ConnectionString = "workstation id=KETABIE;packet size=4096;user id=sa;data source=""."";persist securi" & _
        "ty info=True;initial catalog=TireMate_07;password=sa"
        '
        'SqlSelectCommand1
        '
        ...
        "ve, bas_cc_type.cc_type_desc FROM Gl_receive_payment LEFT OUTER JOIN cust_trtab_" & _
        "main ON Gl_receive_payment.cod_customer = cust_trtab_main.cod_customer LEFT OUTE" & _
        "R JOIN bas_cc_type ON Gl_receive_payment.cc_type = bas_cc_type.cc_type LEFT OUTE" & _
        "R JOIN cust_company ON cust_trtab_main.cod_company = cust_company.cod_company"
        ...
        Me.UcPrintGrid1.Location = New System.Drawing.Point(456, 8)
        ...
        '
        'FrmEndOfDayCreditCardReceipts
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(654, 348)
        Me.Controls.Add(Me.Panel4)
        Me.Controls.Add(Me.GridEX1)
        Me.Name = "FrmEndOfDayCreditCardReceipts"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Credit Card Receipts"
        CType(Me.GridEX1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.DsFrmEndOfDayCreditCardReceipts1, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    Private Sub FrmCheckInvoices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DAGl_receive_payment.Fill(DsFrmEndOfDayCreditCardReceipts1.Gl_receive_payment)
