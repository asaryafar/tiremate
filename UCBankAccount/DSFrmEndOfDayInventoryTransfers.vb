...
Public Class DSFrmEndOfDayInventoryTransfers
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayInventoryTransfers = CType(MyBase.Clone,DSFrmEndOfDayInventoryTransfers)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayInventoryTransfers"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayInventoryTransfers.xsd"
    ...
    Public Class inv_sales_transfer_dtlDataTable
        ...
        Public Overloads Function Addinv_sales_transfer_dtlRow(ByVal ID_sales_transfer As String, ByVal item_no As String, ByVal ExtCost As Decimal, ByVal desc_item As String, ByVal ReplCost As Single, ByVal fet As Single, ByVal store_to As String, ByVal qty As Decimal) As inv_sales_transfer_dtlRow
            Dim rowinv_sales_transfer_dtlRow As inv_sales_transfer_dtlRow = CType(Me.NewRow,inv_sales_transfer_dtlRow)
            rowinv_sales_transfer_dtlRow.ItemArray = New Object() {ID_sales_transfer, item_no, ExtCost, desc_item, ReplCost, fet, store_to, qty}
    ...
    Public Class inv_sales_transfer_dtlRow
        ...
        Public Property ExtCost As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableinv_sales_transfer_dtl.ExtCostColumn),Decimal)
