...
Public Class DSFrmCashPaidOutPrint
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmCashPaidOutPrint = CType(MyBase.Clone,DSFrmCashPaidOutPrint)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmCashPaidOutPrint"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmCashPaidOutPrint.xsd"
    ...
    Public Class GL_Paid_receivedDataTable
        ...
        Private columnPayMethod As DataColumn
        ...
        Friend ReadOnly Property PayMethodColumn As DataColumn
            Get
        ...
        Public Overloads Function AddGL_Paid_receivedRow( _
                    ...
                    ByVal desc_vendor As String) As GL_Paid_receivedRow
            Dim rowGL_Paid_receivedRow As GL_Paid_receivedRow = CType(Me.NewRow,GL_Paid_receivedRow)
            rowGL_Paid_receivedRow.ItemArray = New Object() {refrence_code, tran_type, action_date, customer_code, vendor_code, amount, GL_account, memo, Id_GL_journal, OtherReceipType, Id_debit_deposit_head, id_service_center, CustomerName, company, PayMethod, desc_GL_account, desc_vendor}
        ...
        Friend Sub InitVars()
            ...
            Me.columnPayMethod = Me.Columns("PayMethod")
        ...
        Private Sub InitClass()
            ...
            Me.columnPayMethod = New DataColumn("PayMethod", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnPayMethod)
            ...
            Me.columnPayMethod.ReadOnly = true
        End Sub
    ...
    Public Class GL_Paid_receivedRow
        ...
        Public Property CustomerName As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.CustomerNameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.CustomerNameColumn) = value
            End Set
        End Property
        ...
        Public Property company As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.companyColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.companyColumn) = value
            End Set
        End Property
        ...
        Public Property PayMethod As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.PayMethodColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.PayMethodColumn) = value
            End Set
        End Property
        ...
        Public Property desc_GL_account As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.desc_GL_accountColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.desc_GL_accountColumn) = value
            End Set
        End Property
        ...
        Public Property desc_vendor As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.desc_vendorColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.desc_vendorColumn) = value
            End Set
        End Property
        ...
        Public Function IsCustomerNameNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.CustomerNameColumn)
        End Function
        
        Public Sub SetCustomerNameNull()
            Me(Me.tableGL_Paid_received.CustomerNameColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IscompanyNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.companyColumn)
        End Function
        
        Public Sub SetcompanyNull()
            Me(Me.tableGL_Paid_received.companyColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsPayMethodNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.PayMethodColumn)
        End Function
        
        Public Sub SetPayMethodNull()
            Me(Me.tableGL_Paid_received.PayMethodColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Isdesc_GL_accountNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.desc_GL_accountColumn)
        End Function
        
        Public Sub Setdesc_GL_accountNull()
            Me(Me.tableGL_Paid_received.desc_GL_accountColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Isdesc_vendorNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.desc_vendorColumn)
        End Function
        
        Public Sub Setdesc_vendorNull()
            Me(Me.tableGL_Paid_received.desc_vendorColumn) = System.Convert.DBNull
        End Sub
    End Class
