...
Imports CommonClass
Public Class FrmEndOfDayLaborSuppliesSales
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEndOfDayLaborSuppliesSales))
        ...
        "FormatString>####.##</FormatString><InputMask>Percent2</InputMask><Key>GrProfPer" & _
        "cent</Key><MaskPrompt>&#x0;</MaskPrompt><Position>7</Position><Width>66</Width><" & _
        "/Column7><Column8 ID=""Type""><Caption>Type</Caption><DataMember>Type</DataMember>" & _
        "<Key>Type</Key><Position>8</Position><Width>73</Width></Column8></Columns><Group" & _
        "Condition ID="""" /><Key>service_center_dtl</Key></RootTable></GridEXLayoutData>"
        ...
        Me.GridEX1.Size = New System.Drawing.Size(718, 346)
        ...
        'SqlSelectCommand1
        '
        Me.SqlSelectCommand1.CommandText = "SELECT service_center_dtl.id_service_center, ISNULL(service_center_dtl.qty, 0) AS" & _
        " qty, ISNULL(service_center_dtl.qty * (service_center_dtl.price + service_center" & _
        "_dtl.fet), 0) AS Ext_Price, service_center_dtl.cod_select, inv_tab_labor_service" & _
        ...
        ".qty * (service_center_dtl.price + service_center_dtl.fet), 0) - ISNULL(service_" & _
        "center_dtl.qty * inv_tab_labor_service.cost, 0) AS GrProfAmount, (CASE ISNULL(se" & _
        "rvice_center_dtl.qty * (service_center_dtl.price + service_center_dtl.fet), 0) W" & _
        "HEN 0 THEN 0 ELSE (((ISNULL(service_center_dtl.qty * (service_center_dtl.price +" & _
        " service_center_dtl.fet), 0)) - ISNULL(service_center_dtl.qty * inv_tab_labor_se" & _
        "rvice.cost, 0)) / (ISNULL(service_center_dtl.qty * (service_center_dtl.price + s" & _
        "ervice_center_dtl.fet), 0))) END) * 100 AS GrProfPercent FROM service_center_dtl" & _
        " INNER JOIN service_center_head ON service_center_dtl.id_service_center = servic" & _
        "e_center_head.id_service_center LEFT OUTER JOIN inv_tab_labor_service ON service" & _
        "_center_dtl.cod_select = inv_tab_labor_service.cod_service LEFT OUTER JOIN inv_t" & _
        "ab_service_type ON inv_tab_labor_service.service_type = inv_tab_service_type.ser" & _
        "vice_type"
        ...
        '
        'FrmEndOfDayLaborSuppliesSales
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(718, 391)
        Me.Controls.Add(Me.Panel4)
        Me.Controls.Add(Me.GridEX1)
        Me.Name = "FrmEndOfDayLaborSuppliesSales"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Labor And Supplies Sales"
