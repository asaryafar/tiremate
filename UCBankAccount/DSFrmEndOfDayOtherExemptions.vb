...
Public Class DSFrmEndOfDayOtherExemptions
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayOtherExemptions = CType(MyBase.Clone,DSFrmEndOfDayOtherExemptions)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayOtherExemptions"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayOtherExemptions.xsd"
    ...
    Public Class service_center_dtlDataTable
        ...
        Public Overloads Function Addservice_center_dtlRow(ByVal id_service_center As String, ByVal date_refer As String, ByVal cod_customer As String, ByVal fullname As String, ByVal abbreviation_name As String, ByVal tax As Decimal, ByVal discount As Decimal, ByVal Total As Decimal, ByVal cost As Decimal, ByVal flag As Decimal, ByVal GrProfAmount As Decimal, ByVal GrProfPercent As Decimal, ByVal SUBTOTAL As Decimal) As service_center_dtlRow
            Dim rowservice_center_dtlRow As service_center_dtlRow = CType(Me.NewRow,service_center_dtlRow)
            rowservice_center_dtlRow.ItemArray = New Object() {id_service_center, date_refer, cod_customer, fullname, abbreviation_name, tax, discount, Total, cost, flag, GrProfAmount, GrProfPercent, SUBTOTAL}
        ...
        Private Sub InitClass()
            ...
            Me.columnflag = New DataColumn("flag", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
    ...
    Public Class service_center_dtlRow
        ...
        Public Property tax As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.taxColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.taxColumn) = value
            End Set
        End Property
        ...
        Public Property flag As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.flagColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
        ...
        Public Property SUBTOTAL As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableservice_center_dtl.SUBTOTALColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableservice_center_dtl.SUBTOTALColumn) = value
            End Set
        End Property
        ...
        Public Function IstaxNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.taxColumn)
        End Function
        
        Public Sub SettaxNull()
            Me(Me.tableservice_center_dtl.taxColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IsSUBTOTALNull() As Boolean
            Return Me.IsNull(Me.tableservice_center_dtl.SUBTOTALColumn)
        End Function
        
        Public Sub SetSUBTOTALNull()
            Me(Me.tableservice_center_dtl.SUBTOTALColumn) = System.Convert.DBNull
        End Sub
    End Class
