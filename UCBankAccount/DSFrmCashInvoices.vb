...
Public Class DSFrmCashInvoices
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmCashInvoices = CType(MyBase.Clone,DSFrmCashInvoices)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmCashInvoices"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmCashInvoices.xsd"
    ...
    Public Class GL_payment_cashRow
        ...
        Public Function Isid_service_centerNull() As Boolean
            Return Me.IsNull(Me.tableGL_payment_cash.id_service_centerColumn)
        End Function
        
        Public Sub Setid_service_centerNull()
            Me(Me.tableGL_payment_cash.id_service_centerColumn) = System.Convert.DBNull
        End Sub
