Imports CommonClass
Public Class FrmEndOfDayCashPaidOut
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEndOfDayCashPaidOut))
        ...
        ">73</Width></Column1><Column2 ID=""amount""><Caption>Cash Paid</Caption><DataMembe" & _
        "r>amount</DataMember><FormatString>c</FormatString><Key>amount</Key><Position>2<" & _
        "/Position><TextAlignment>Far</TextAlignment></Column2><Column3 ID=""fullname""><Ca" & _
        "ption>Customer Name</Caption><DataMember>fullname</DataMember><EditType>NoEdit</" & _
        "EditType><Key>fullname</Key><Position>3</Position><Width>206</Width></Column3><C" & _
        "olumn4 ID=""abbreviation_name""><Caption>Company</Caption><DataMember>abbreviation" & _
        "_name</DataMember><Key>abbreviation_name</Key><Position>4</Position><Width>167</" & _
        "Width></Column4></Columns><GroupCondition ID="""" /><Key>GL_Paid_received</Key></R" & _
        ...
        "ved LEFT OUTER JOIN cust_trtab_main ON GL_Paid_received.customer_code = cust_trt" & _
        "ab_main.cod_customer LEFT OUTER JOIN cust_company ON cust_trtab_main.cod_company" & _
