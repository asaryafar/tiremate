...
Public Class DSFrmEndOfDayCheckReceipts
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayCheckReceipts = CType(MyBase.Clone,DSFrmEndOfDayCheckReceipts)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayCheckReceipts"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayCheckReceipts.xsd"
    ...
    Public Class Gl_receive_paymentDataTable
        ...
        Public Overloads Function AddGl_receive_paymentRow(ByVal refrence_no As String, ByVal date_receive_payment As String, ByVal fullname As String, ByVal abbreviation_name As String, ByVal amount_receive As Single, ByVal check_no As String) As Gl_receive_paymentRow
            Dim rowGl_receive_paymentRow As Gl_receive_paymentRow = CType(Me.NewRow,Gl_receive_paymentRow)
            rowGl_receive_paymentRow.ItemArray = New Object() {refrence_no, date_receive_payment, fullname, abbreviation_name, amount_receive, check_no}
