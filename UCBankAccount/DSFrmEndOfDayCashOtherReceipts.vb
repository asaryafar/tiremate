...
Public Class DSFrmEndOfDayCashOtherReceipts
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayCashOtherReceipts = CType(MyBase.Clone,DSFrmEndOfDayCashOtherReceipts)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayCashOtherReceipts"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayCashOtherReceipts.xsd"
    ...
    Public Class GL_Paid_receivedDataTable
        ...
        Public Overloads Function AddGL_Paid_receivedRow(ByVal fullname As String, ByVal abbreviation_name As String, ByVal refrence_code As String, ByVal action_date As String, ByVal amount As Decimal) As GL_Paid_receivedRow
            Dim rowGL_Paid_receivedRow As GL_Paid_receivedRow = CType(Me.NewRow,GL_Paid_receivedRow)
            rowGL_Paid_receivedRow.ItemArray = New Object() {fullname, abbreviation_name, refrence_code, action_date, amount}
