...
Public Class DSFrmSearchCashPaidOut
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmSearchCashPaidOut = CType(MyBase.Clone,DSFrmSearchCashPaidOut)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmSearchCashPaidOut"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmSearchCashPaidOut.xsd"
    ...
    Public Class GL_Paid_receivedDataTable
        ...
        Private columnThisCode As DataColumn
        ...
        Friend ReadOnly Property ThisCodeColumn As DataColumn
            Get
                Return Me.columnThisCode
            End Get
        End Property
        ...
        Public Overloads Function AddGL_Paid_receivedRow(ByVal refrence_code As String, ByVal tran_type As String, ByVal action_date As String, ByVal customer_code As String, ByVal vendor_code As String, ByVal amount As Decimal, ByVal GL_account As String, ByVal memo As String, ByVal OtherReceipType As String, ByVal FullName As String, ByVal companyName As String, ByVal ThisCode As String) As GL_Paid_receivedRow
            Dim rowGL_Paid_receivedRow As GL_Paid_receivedRow = CType(Me.NewRow,GL_Paid_receivedRow)
            rowGL_Paid_receivedRow.ItemArray = New Object() {refrence_code, tran_type, action_date, customer_code, vendor_code, amount, GL_account, memo, OtherReceipType, FullName, companyName, ThisCode}
        ...
        Friend Sub InitVars()
            ...
            Me.columnThisCode = Me.Columns("ThisCode")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnThisCode = New DataColumn("ThisCode", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnThisCode)
    ...
    Public Class GL_Paid_receivedRow
        ...
        Public Property companyName As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.companyNameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.companyNameColumn) = value
            End Set
        End Property
        
        Public Property ThisCode As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_Paid_received.ThisCodeColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_Paid_received.ThisCodeColumn) = value
            End Set
        End Property
        ...
        Public Function IscompanyNameNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.companyNameColumn)
        End Function
        
        Public Sub SetcompanyNameNull()
            Me(Me.tableGL_Paid_received.companyNameColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsThisCodeNull() As Boolean
            Return Me.IsNull(Me.tableGL_Paid_received.ThisCodeColumn)
        End Function
        
        Public Sub SetThisCodeNull()
            Me(Me.tableGL_Paid_received.ThisCodeColumn) = System.Convert.DBNull
        End Sub
    End Class
