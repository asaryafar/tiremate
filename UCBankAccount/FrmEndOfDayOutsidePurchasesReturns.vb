...
Imports CommonClass
Public Class FrmEndOfDayOutsidePurchasesReturns
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmEndOfDayOutsidePurchasesReturns1 As UCBankAccount.DSFrmEndOfDayOutsidePurchasesReturns
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEndOfDayOutsidePurchasesReturns))
        Me.GridEX1 = New Janus.Windows.GridEX.GridEX
        Me.DsFrmEndOfDayOutsidePurchasesReturns1 = New UCBankAccount.DSFrmEndOfDayOutsidePurchasesReturns
        ...
        CType(Me.DsFrmEndOfDayOutsidePurchasesReturns1, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.GridEX1.DataSource = Me.DsFrmEndOfDayOutsidePurchasesReturns1
        ...
        ">0</Position><Width>85</Width></Column0><Column1 ID=""cod_select""><Caption>Item N" & _
        "o.</Caption><DataMember>cod_select</DataMember><Key>cod_select</Key><Position>1<" & _
        "/Position><Width>85</Width></Column1><Column2 ID=""desc_item""><Caption>Descriptio" & _
        "n</Caption><DataMember>desc_item</DataMember><Key>desc_item</Key><Position>2</Po" & _
        "sition><Width>226</Width></Column2><Column3 ID=""qty""><Caption>Qty</Caption><Type" & _
        "NameEmptyStringValue>NULL</TypeNameEmptyStringValue><EmptyStringValue /><DataMem" & _
        "ber>qty</DataMember><InputMask>####</InputMask><Key>qty</Key><Position>3</Positi" & _
        "on><Width>69</Width></Column3><Column4 ID=""Ext_Price""><Caption>Ext. Price</Capti" & _
        "on><DataMember>Ext_Price</DataMember><EditType>NoEdit</EditType><FormatString>c2" & _
        "</FormatString><Key>Ext_Price</Key><Position>4</Position><TextAlignment>Far</Tex" & _
        "tAlignment><Width>82</Width></Column4><Column5 ID=""cod_vendor""><Caption>Vendor</" & _
        "Caption><DataMember>cod_vendor</DataMember><Key>cod_vendor</Key><Position>5</Pos" & _
        "ition><Width>64</Width></Column5><Column6 ID=""invoice_no""><Caption>Invoice No</C" & _
        "aption><DataMember>invoice_no</DataMember><Key>invoice_no</Key><Position>6</Posi" & _
        "tion></Column6></Columns><GroupCondition ID="""" /><Key>service_center_dtl</Key></" & _
        ...
        Me.GridEX1.Size = New System.Drawing.Size(742, 343)
        Me.GridEX1.TabIndex = 0
        '
        'DsFrmEndOfDayOutsidePurchasesReturns1
        '
        Me.DsFrmEndOfDayOutsidePurchasesReturns1.DataSetName = "DSFrmEndOfDayOutsidePurchasesReturns"
        Me.DsFrmEndOfDayOutsidePurchasesReturns1.Locale = New System.Globalization.CultureInfo("fa-IR")
        '
        'Cnn
        '
        ...
        "hases.invoice_no, inv_item.desc_item FROM service_center_dtl INNER JOIN service_" & _
        "center_head ON service_center_dtl.id_service_center = service_center_head.id_ser" & _
        "vice_center INNER JOIN service_out_purchases ON service_center_dtl.id_service_ce" & _
        "nter = service_out_purchases.id_service_center AND service_center_dtl.radif = se" & _
        "rvice_out_purchases.radif INNER JOIN inv_item ON service_center_dtl.cod_select =" & _
        " inv_item.item_no"
        ...
        '
        'FrmEndOfDayOutsidePurchasesReturns
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(742, 388)
        Me.Controls.Add(Me.Panel4)
        Me.Controls.Add(Me.GridEX1)
        Me.Name = "FrmEndOfDayOutsidePurchasesReturns"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Outside Purchases Returns"
        CType(Me.GridEX1, System.ComponentModel.ISupportInitialize).EndInit()
        CType(Me.DsFrmEndOfDayOutsidePurchasesReturns1, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    Private Sub FrmCashInvoices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DAservice_center_dtl.Fill(DsFrmEndOfDayOutsidePurchasesReturns1.service_center_dtl)
