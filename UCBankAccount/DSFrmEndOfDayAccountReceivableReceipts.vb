...
Public Class DSFrmEndOfDayAccountReceivableReceipts
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayAccountReceivableReceipts = CType(MyBase.Clone,DSFrmEndOfDayAccountReceivableReceipts)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayAccountReceivableReceipts"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayAccountReceivableReceipts.xsd"
    ...
    Public Class Gl_receive_paymentDataTable
        ...
        Private columnNew_Balance As DataColumn
        ...
        Friend ReadOnly Property New_BalanceColumn As DataColumn
            Get
        ...
        Public Overloads Function AddGl_receive_paymentRow(ByVal refrence_no As String, ByVal fullname As String, ByVal abbreviation_name As String, ByVal amount_receive As Single, ByVal date_receive_payment As String, ByVal pmt_method As String, ByVal New_Balance As Decimal) As Gl_receive_paymentRow
            Dim rowGl_receive_paymentRow As Gl_receive_paymentRow = CType(Me.NewRow,Gl_receive_paymentRow)
            rowGl_receive_paymentRow.ItemArray = New Object() {refrence_no, fullname, abbreviation_name, amount_receive, date_receive_payment, pmt_method, New_Balance}
        ...
        Friend Sub InitVars()
            ...
            Me.columnNew_Balance = Me.Columns("New_Balance")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnNew_Balance = New DataColumn("New_Balance", GetType(System.Decimal), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnNew_Balance)
            Me.columnrefrence_no.AllowDBNull = false
            Me.columnfullname.ReadOnly = true
            Me.columnNew_Balance.ReadOnly = true
        End Sub
    ...
    Public Class Gl_receive_paymentRow
        ...
        Public Property abbreviation_name As String
            Get
                Try 
                    Return CType(Me(Me.tableGl_receive_payment.abbreviation_nameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGl_receive_payment.abbreviation_nameColumn) = value
            End Set
        End Property
        ...
        Public Property New_Balance As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableGl_receive_payment.New_BalanceColumn),Decimal)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGl_receive_payment.New_BalanceColumn) = value
            End Set
        End Property
        ...
        Public Function Isabbreviation_nameNull() As Boolean
            Return Me.IsNull(Me.tableGl_receive_payment.abbreviation_nameColumn)
        End Function
        
        Public Sub Setabbreviation_nameNull()
            Me(Me.tableGl_receive_payment.abbreviation_nameColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IsNew_BalanceNull() As Boolean
            Return Me.IsNull(Me.tableGl_receive_payment.New_BalanceColumn)
        End Function
        
        Public Sub SetNew_BalanceNull()
            Me(Me.tableGl_receive_payment.New_BalanceColumn) = System.Convert.DBNull
        End Sub
    End Class
