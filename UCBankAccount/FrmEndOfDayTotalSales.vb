...
Imports CommonClass
Public Class FrmEndOfDayTotalSales
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEndOfDayTotalSales))
        ...
        "on>2</Position><Width>79</Width></Column2><Column3 ID=""Total""><AggregateFunction" & _
        ">Sum</AggregateFunction><Caption>Total Amount</Caption><DataMember>Total</DataMe" & _
        "mber><FormatString>c2</FormatString><Key>Total</Key><Position>3</Position><TextA" & _
        "lignment>Far</TextAlignment><Width>87</Width><TotalFormatString>c2</TotalFormatS" & _
        "tring></Column3><Column4 ID=""fullname""><Caption>Customer Name</Caption><DataMemb" & _
        "er>fullname</DataMember><EditType>NoEdit</EditType><Key>fullname</Key><Position>" & _
        "4</Position><Width>170</Width></Column4><Column5 ID=""abbreviation_name""><Caption" & _
        ">Company</Caption><DataMember>abbreviation_name</DataMember><Key>abbreviation_na" & _
        "me</Key><Position>5</Position><Width>125</Width></Column5><Column6 ID=""discount""" & _
        "><Caption>Discount %</Caption><DataMember>discount</DataMember><Key>discount</Ke" & _
        "y><MaskPrompt>&#x0;</MaskPrompt><Position>6</Position><Width>67</Width></Column6" & _
        "></Columns><GroupCondition ID="""" /><Key>service_center_head</Key></RootTable></G" & _
        "ridEXLayoutData>"
...
#End Region
    Private Sub FrmCashInvoices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DAservice_center_head.SelectCommand.CommandText = DAservice_center_head.SelectCommand.CommandText & WhereClauseVar & " AND (service_center_head.id_service_center not in (SELECT id_service_center FROM service_center_dtl WHERE (type_select = 'B'))) ORDER BY service_center_head.id_service_center"
