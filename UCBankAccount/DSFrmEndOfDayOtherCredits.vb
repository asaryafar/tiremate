...
Public Class DSFrmEndOfDayOtherCredits
    Inherits DataSet
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DSFrmEndOfDayOtherCredits = CType(MyBase.Clone,DSFrmEndOfDayOtherCredits)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DSFrmEndOfDayOtherCredits"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DSFrmEndOfDayOtherCredits.xsd"
    ...
    Public Class GL_account_adjustment_headDataTable
        ...
        Public Overloads Function AddGL_account_adjustment_headRow(ByVal refrence_no As String, ByVal date_adjustment As String, ByVal amount_adjustment As Decimal, ByVal desc_GL_account As String) As GL_account_adjustment_headRow
            Dim rowGL_account_adjustment_headRow As GL_account_adjustment_headRow = CType(Me.NewRow,GL_account_adjustment_headRow)
            rowGL_account_adjustment_headRow.ItemArray = New Object() {refrence_no, date_adjustment, amount_adjustment, desc_GL_account}
    ...
    Public Class GL_account_adjustment_headRow
        ...
        Public Property desc_GL_account As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account_adjustment_head.desc_GL_accountColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account_adjustment_head.desc_GL_accountColumn) = value
            End Set
        End Property
        ...
        Public Function Isdesc_GL_accountNull() As Boolean
            Return Me.IsNull(Me.tableGL_account_adjustment_head.desc_GL_accountColumn)
        End Function
        
        Public Sub Setdesc_GL_accountNull()
            Me(Me.tableGL_account_adjustment_head.desc_GL_accountColumn) = System.Convert.DBNull
        End Sub
    End Class
