...
Imports CommonClass
Public Class FrmEndOfDayInventoryTransfers
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmEndOfDayInventoryTransfers1 As UCBankAccount.DSFrmEndOfDayInventoryTransfers
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmEndOfDayInventoryTransfers))
        Me.GridEX1 = New Janus.Windows.GridEX.GridEX
        Me.DsFrmEndOfDayInventoryTransfers1 = New UCBankAccount.DSFrmEndOfDayInventoryTransfers
        ...
        CType(Me.DsFrmEndOfDayInventoryTransfers1, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.GridEX1.DataSource = Me.DsFrmEndOfDayInventoryTransfers1
        ...
        "tion>0</Position><Width>87</Width></Column0><Column1 ID=""item_no""><Caption>Item " & _
        ...
        "</Position><Width>70</Width></Column1><Column2 ID=""desc_item""><Caption>Descripti" & _
        "on</Caption><DataMember>desc_item</DataMember><Key>desc_item</Key><Position>2</P" & _
        "osition><Width>185</Width></Column2><Column3 ID=""qty""><Caption>Qty Trnfd</Captio" & _
        "n><DataMember>qty</DataMember><Key>qty</Key><Position>3</Position><TextAlignment" & _
        ">Center</TextAlignment><Width>58</Width></Column3><Column4 ID=""ReplCost""><Captio" & _
        "n>Repl. Cost</Caption><DataMember>ReplCost</DataMember><EditType>NoEdit</EditTyp" & _
        "e><FormatString>C2</FormatString><Key>ReplCost</Key><Position>4</Position><Width" & _
        ">79</Width></Column4><Column5 ID=""fet""><Caption>FET</Caption><DataMember>fet</Da" & _
        "taMember><FormatString>c2</FormatString><Key>fet</Key><Position>5</Position><Wid" & _
        "th>79</Width></Column5><Column6 ID=""ExtCost""><Caption>Ext. Cost</Caption><DataMe" & _
        "mber>ExtCost</DataMember><EditType>NoEdit</EditType><FormatString>c2</FormatStri" & _
        "ng><Key>ExtCost</Key><Position>6</Position><TextAlignment>Far</TextAlignment><Wi" & _
        "dth>78</Width></Column6><Column7 ID=""store_to""><Caption>To Store</Caption><DataM" & _
        "ember>store_to</DataMember><Key>store_to</Key><Position>7</Position><Width>57</W" & _
        "idth></Column7></Columns><GroupCondition ID="""" /><Key>inv_sales_transfer_dtl</Ke" & _
        "y></RootTable></GridEXLayoutData>"
        ...
        '
        'DsFrmEndOfDayInventoryTransfers1
        '
        Me.DsFrmEndOfDayInventoryTransfers1.DataSetName = "DSFrmEndOfDayInventoryTransfers"
        Me.DsFrmEndOfDayInventoryTransfers1.Locale = New System.Globalization.CultureInfo("fa-IR")
        '
        'Cnn
        '
        ...
        "dtl.fet) AS ExtCost, inv_item.desc_item, inv_item_cost_transaction.cost + inv_it" & _
        "em_cost_transaction.delivery + inv_item_cost_transaction.frieght AS ReplCost, in" & _
        "v_item_cost_transaction.fet, inv_salse_transfer_head.store_to, inv_sales_transfe" & _
        "r_dtl.qty FROM inv_sales_transfer_dtl LEFT OUTER JOIN inv_salse_transfer_head ON" & _
        " inv_sales_transfer_dtl.ID_sales_transfer = inv_salse_transfer_head.ID_sales_tra" & _
        "nsfer LEFT OUTER JOIN inv_item ON inv_sales_transfer_dtl.item_no = inv_item.item" & _
...
#End Region
    Private Sub FrmCashInvoices_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DAinv_sales_transfer_dtl.Fill(DsFrmEndOfDayInventoryTransfers1.inv_sales_transfer_dtl)
    ...
    Private Sub GridEX1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridEX1.DoubleClick
        If GridEX1.RowCount > 0 Then
            ...
            MyFrmInterStoreSale.TypeOfForm = 2
