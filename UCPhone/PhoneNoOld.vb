...
Public Class PhoneNo
    ...
    Shadows Property Text() As String
        ...
        Set(ByVal Value As String)
            _Text = Value.Trim
            If _Text <> "" And Val(Mid(_Text, 1, 4)) > 0 Then
                mText = _Text.Split("-")
    ...
    Public Property PhoneNo() As String
        Get
            Dim DateReturnValue As String
            DateReturnValue = TxtNo1.Text & "-" & TxtNo2.Text & "-" & TxtNo3.Text
            If DateReturnValue.Trim.Length < 12 Then
                DateReturnValue = ""
            End If
        ...
        Set(ByVal Value As String)
            Try
                TxtNo1.Text = Mid(Value, 1, 3)
                TxtNo2.Text = Mid(Value, 5, 3)
                TxtNo3.Text = Mid(Value, 9, 4)
        ...
        End Set
    End Property
    Public ReadOnly Property RealCalendarValue() As String
        Get
            Dim DateReturnValue As String
            'DateReturnValue = Space(4 - TxtNo1.Text.Trim.Length) & TxtNo1.Text.Trim & "-" & Space(2 - TxtNo2.Text.Trim.Length) & TxtNo2.Text.Trim & "-" & Space(2 - TxtNo3.Text.Trim.Length) & TxtNo3.Text.Trim
            DateReturnValue = RealValue
            Return DateReturnValue
        End Get
    End Property
