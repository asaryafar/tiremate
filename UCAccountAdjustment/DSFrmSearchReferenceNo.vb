...
Public Class DSFrmSearchReferenceNo
    ...
    Public Class GL_account_adjustment_headDataTable
        ...
        Public Overloads Function AddGL_account_adjustment_headRow(ByVal refrence_no As String, ByVal cod_customer As String, ByVal amount_adjustment As Decimal, ByVal date_adjustment As String, ByVal Remark As String, ByVal GL_account As String, ByVal id_GL_journal As Integer, ByVal Gl_receive_payment_Refrence_no As String, ByVal finance_charge_flag As Boolean, ByVal FromStoreNo As String, ByVal l_name As String, ByVal abbreviation_name As String, ByVal Old_Amount_adjustment As Decimal) As GL_account_adjustment_headRow
            Dim rowGL_account_adjustment_headRow As GL_account_adjustment_headRow = CType(Me.NewRow,GL_account_adjustment_headRow)
            rowGL_account_adjustment_headRow.ItemArray = New Object() {refrence_no, cod_customer, amount_adjustment, date_adjustment, Remark, GL_account, id_GL_journal, Gl_receive_payment_Refrence_no, finance_charge_flag, FromStoreNo, l_name, abbreviation_name, Old_Amount_adjustment}
    ...
    Public Class GL_account_adjustment_headRow
        ...
        Public Property l_name As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account_adjustment_head.l_nameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account_adjustment_head.l_nameColumn) = value
            End Set
        End Property
        ...
        Public Property abbreviation_name As String
            Get
                Try 
                    Return CType(Me(Me.tableGL_account_adjustment_head.abbreviation_nameColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableGL_account_adjustment_head.abbreviation_nameColumn) = value
            End Set
        End Property
        ...
        Public Function Isl_nameNull() As Boolean
            Return Me.IsNull(Me.tableGL_account_adjustment_head.l_nameColumn)
        End Function
        
        Public Sub Setl_nameNull()
            Me(Me.tableGL_account_adjustment_head.l_nameColumn) = System.Convert.DBNull
        End Sub
        
        Public Function Isabbreviation_nameNull() As Boolean
            Return Me.IsNull(Me.tableGL_account_adjustment_head.abbreviation_nameColumn)
        End Function
        
        Public Sub Setabbreviation_nameNull()
            Me(Me.tableGL_account_adjustment_head.abbreviation_nameColumn) = System.Convert.DBNull
        End Sub
