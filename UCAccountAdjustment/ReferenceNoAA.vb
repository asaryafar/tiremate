...
Public Class Reference_NoAA
    ...
    Private MLenAccountAdjustmentReferenceNo As Integer = LenAccountAdjustmentReferenceNo
    ...
    Dim WithEvents ClsAccountAdjustment1 As New ClsAccountAdjustment
    ...
    Public Property ReferenceNoLen() As Integer
        Get
            Return MLenAccountAdjustmentReferenceNo
        End Get
        Set(ByVal Value As Integer)
            MLenAccountAdjustmentReferenceNo = LenAccountAdjustmentReferenceNo
            TxtReferencNo.MaxLength = LenAccountAdjustmentReferenceNo
        End Set
    End Property
    Public Property Connection() As System.Data.SqlClient.SqlConnection
        ...
        Set(ByVal Value As System.Data.SqlClient.SqlConnection)
            MCnn = Value
            ClsAccountAdjustment1.Connection = MCnn
        End Set
    End Property
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Reference_NoAA))
        ...
        Me.TxtReferencNo.Size = New System.Drawing.Size(85, 20)
        ...
        Me.BtnSearch.Location = New System.Drawing.Point(85, 0)
...
#End Region
    ...
    Private Function FindThisReferencNo() As Boolean
        ...
        'If ClsAccountAdjustment1.FindDesc(Getcod(TxtReferencNo.Text, MVendorCodLen)) Then
        If ClsAccountAdjustment1.FindDesc(TxtReferencNo.Text.Trim) Then
            FindThisReferencNo = True
            MReferenc_No = ClsAccountAdjustment1.Refrence_No.Trim
            Mcod_customer = ClsAccountAdjustment1.cod_customer.Trim
    ...
    Private Sub TxtReferencNo_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp, TxtReferencNo.KeyUp
        ...
        End Select
    End Sub
    Private Sub MyFrmSearchReferenceNo_AccountAdjustmentFind(ByVal ThisReferencNo As String, ByVal Thiscod_customer As String) Handles MyFrmSearchReferenceNo.AccountAdjustmentFind
    ...
    Public Sub BtnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSearch.Click
        MyFrmSearchReferenceNo.ShowDialog()
    End Sub
    Private Sub ClsAccountAdjustment1_FindReferenceNoRow(ByVal ThisRow As System.Data.DataRow) Handles ClsAccountAdjustment1.FindReferenceNoRow
