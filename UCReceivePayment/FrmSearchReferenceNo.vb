...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DsFrmSearchReferenceNo1 As UCReceivePayment.DSFrmSearchReferenceNo
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DsFrmSearchReferenceNo1 = New UCReceivePayment.DSFrmSearchReferenceNo
        ...
        ">FullName</DataMember><EditType>NoEdit</EditType><Key>FullName</Key><Position>2<" & _
        "/Position><Width>133</Width></Column2><Column3 ID=""companyName""><Caption>Company" & _
        "</Caption><DataMember>companyName</DataMember><Key>companyName</Key><Position>3<" & _
        "/Position><Width>142</Width></Column3><Column4 ID=""amount_receive""><Caption>Amou" & _
        "nt</Caption><DataMember>amount_receive</DataMember><FormatString>c2</FormatStrin" & _
        "g><Key>amount_receive</Key><Position>4</Position><Width>87</Width></Column4><Col" & _
        "umn5 ID=""date_receive_payment""><Caption>Date</Caption><DataMember>date_receive_p" & _
        "ayment</DataMember><Key>date_receive_payment</Key><Position>5</Position><Width>8" & _
        "1</Width></Column5></Columns><GroupCondition ID="""" /><Key>Gl_receive_payment</Ke" & _
