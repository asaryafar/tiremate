...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Reference_No1 As UCReceivePayment.Reference_No
    ...
    Friend WithEvents DsFrmReceivePayment1 As UCReceivePayment.DSFrmReceivePayment
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Reference_No1 = New UCReceivePayment.Reference_No
        ...
        Me.DsFrmReceivePayment1 = New UCReceivePayment.DSFrmReceivePayment
        ...
        Me.CmdDelete.Parameters.Add(New System.Data.SqlClient.SqlParameter("@refrence_no", System.Data.SqlDbType.VarChar, 6, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "refrence_no", System.Data.DataRowVersion.Original, Nothing))
        '
        'PnlSearch
        '
        ...
        "></Column5><Column6 ID=""Discount""><Caption>Discount %</Caption><DataMember>Disco" & _
        "unt</DataMember><FormatString>###.##</FormatString><InputMask>Number2</InputMask" & _
        "><Key>Discount</Key><MaskPrompt>&#x0;</MaskPrompt><Position>6</Position><Width>7" & _
        "1</Width></Column6><Column7 ID=""AR_terms""><Caption>AR_terms</Caption><DataMember" & _
        ">AR_terms</DataMember><Key>AR_terms</Key><Position>7</Position><Visible>False</V" & _
        "isible></Column7><Column8 ID=""ThisTableID""><Caption>ThisTableID</Caption><DataMe" & _
        "mber>ThisTableID</DataMember><Key>ThisTableID</Key><Position>8</Position><Visibl" & _
        "e>False</Visible></Column8><Column9 ID=""StoreNo""><Caption>Store No</Caption><Dat" & _
        "aMember>StoreNo</DataMember><EditType>NoEdit</EditType><Key>StoreNo</Key><Positi" & _
        "on>9</Position><Width>54</Width></Column9></Columns><GroupCondition ID="""" /><Key" & _
        ...
        Me.CmdInsert.Parameters.Add(New System.Data.SqlClient.SqlParameter("@refrence_no", System.Data.SqlDbType.VarChar, 6, "refrence_no"))
        ...
        Me.CmdInsert.Parameters.Add(New System.Data.SqlClient.SqlParameter("@OtherStoreRefrence_no", System.Data.SqlDbType.VarChar, 6, "OtherStorerefrence_no"))
        '
        'CmdUpdate
        '
        ...
        Me.CmdUpdate.Parameters.Add(New System.Data.SqlClient.SqlParameter("@refrence_no", System.Data.SqlDbType.VarChar, 6, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "refrence_no", System.Data.DataRowVersion.Original, Nothing))
        '
        'UIContextMenu1
        '
        ...
        Me.SqlSelectCommand4.Parameters.Add(New System.Data.SqlClient.SqlParameter("@refrence_no", System.Data.SqlDbType.VarChar, 6, "refrence_no"))
        '
        ...
        Me.SqlCommand5.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Gl_receive_payment_Refrence_no", System.Data.SqlDbType.VarChar, 6, "Gl_receive_payment_Refrence_no"))
        '
        ...
        Me.SqlCommand6.Parameters.Add(New System.Data.SqlClient.SqlParameter("@refrence_no", System.Data.SqlDbType.VarChar, 6, "refrence_no"))
        '
        'CmdDeleteOtherStore
        '
        ...
        Me.SqlSelectCommand5.Parameters.Add(New System.Data.SqlClient.SqlParameter("@refrence_no", System.Data.SqlDbType.VarChar, 6, "refrence_no"))
        '
                                        ...
                                        If DsFrmReceivePayment1.service_center_dtl.DefaultView(i).Item("Discount") > 0 Then
                                            ...
                                            If AccountAdjustmentVar <> 0 Then
                                                ...
                                                If CmdGeneralLock.ExecuteScalar > 0 Then
                                                    CmdGeneralLock.CommandText = "Update GL_account_adjustment_dtl set amount_adjustment=amount_adjustment+" & -AccountAdjustmentVar & " WHERE id_service_center= " & Qt(DsFrmReceivePayment1.service_center_dtl.DefaultView(i).Item("InvoiceNo")) & " AND refrence_no=" & Qt(GL_account_adjustment_head_Refrence_noVar)
                                                    CmdGeneralLock.ExecuteNonQuery()
                                                Else
                                ...
                                If DsFrmReceivePayment1.GridRecord.DefaultView(i).Item("AR_Adj_Flag") = 0 Then
                                    Try
                                        ...
                                        If dr1 Is Nothing Then
                                            DsFrmReceivePayment1.GridRecord.DefaultView(i).Item("Discount") = CalculateDiscount(DsFrmReceivePayment1.GridRecord.DefaultView(i).Item("InvoiceNo") & "", DsFrmReceivePayment1.GridRecord.DefaultView(i).Item("InvoiceDate") & "", DsFrmReceivePayment1.GridRecord.DefaultView(i).Item("AR_terms") & "", DsFrmReceivePayment1.Store_Setup.Rows(StoreCounterVar).Item("StoreNo"))
                                        Else
                ...
                For i = 0 To DsFrmReceivePayment1.GridRecord.Rows.Count - 1
                    ...
                    If DsFrmReceivePayment1.GridRecord.Rows(i).Item("AR_Adj_Flag") = 0 Then
                        Try
                            ...
                            If dr1 Is Nothing Then
                                DsFrmReceivePayment1.GridRecord.Rows(i).Item("Discount") = CalculateDiscount(DsFrmReceivePayment1.GridRecord.Rows(i).Item("InvoiceNo") & "", DsFrmReceivePayment1.GridRecord.Rows(i).Item("InvoiceDate") & "", DsFrmReceivePayment1.GridRecord.Rows(i).Item("AR_terms") & "", PubStoreNO)
                            Else
    ...
    Private Function MakeNewGL_account_adjustment_headReferenceNo(ByVal ThisConnectionStringVar As String) As String
        ...
        Try
            ...
            If MakeNewGL_account_adjustment_headReferenceNo.Trim.Length > LenAccountAdjustmentReferenceNo Then
                MakeNewGL_account_adjustment_headReferenceNo = "AA0001"
            End If
        Catch ex As Exception
            MakeNewGL_account_adjustment_headReferenceNo = "AA0001"
        End Try
