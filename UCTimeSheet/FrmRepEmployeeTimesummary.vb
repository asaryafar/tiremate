...
Public Class FrmRepEmployeeTimeSummary
    Inherits FrmBase
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmRepEmployeeTimeSummary))
        ...
        Me.GridEX1.DataMember = "Summary"
        Me.GridEX1.DataSource = Me.DsFrmRepEmployeeTime1
        GridEXLayout1.LayoutString = "<GridEXLayoutData><RootTable><Caption>Summary</Caption><Columns Collection=""true""" & _
        "><Column0 ID=""employee_code""><Caption>Code</Caption><DataMember>employee_code</D" & _
        "ataMember><Key>employee_code</Key><Position>0</Position><Width>78</Width></Colum" & _
        "n0><Column1 ID=""EmployeeFullName""><Caption>Employee Name</Caption><DataMember>Em" & _
        "ployeeFullName</DataMember><Key>EmployeeFullName</Key><Position>1</Position><Wid" & _
        "th>314</Width></Column1><Column2 ID=""TotalHours""><Caption>Hours Worked</Caption>" & _
        "<DataMember>TotalHours</DataMember><Key>TotalHours</Key><Position>2</Position></" & _
        "Column2></Columns><GroupCondition ID="""" /><Key>Summary</Key></RootTable></GridEX" & _
        "LayoutData>"
        ...
        '
        'FrmRepEmployeeTimeSummary
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(578, 452)
        Me.Controls.Add(Me.GridEX1)
        Me.Controls.Add(Me.Panel1)
        Me.Name = "FrmRepEmployeeTimeSummary"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Employee Time Report - Summary"
            ...
            If .Rows.Count > 0 Then
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If ChangeEmployeeFlag Then
                        ...
                        DsFrmRepEmployeeTime1.Summary.AddSummaryRow(ThisEmpoyee, .Rows(i).Item("EmployeeFullName"), TotalHoursVar)
                        TotalHoursVar = "000:00"
                    End If
                Next
            End If
